...
const formatTemperamentElements = (
  value: unknown,
  language: T.Language,
): string => {
  if (!value) return "";
...
const formatTemperamentModalities = (
  value: unknown,
  language: T.Language,
): string => {
  if (!value) return "";
...
const NatalScriptCard: React.FC<{
  title: string;
    ...
    <div className="space-y-10">
      <div>
        <SectionHeader
          ...
          onDetailClick={() =>
            handleSynastryDetailClick("elements", context, {
      ...
      <div>
        <SectionHeader
          ...
          detailLabel={t.detail.view_detail}
          onDetailClick={() =>
            handleSynastryDetailClick("aspects", context, {
      ...
      <div>
        <SectionHeader
          ...
          detailLabel={t.detail.view_detail}
          onDetailClick={() =>
            handleSynastryDetailClick("planets", context, {
      ...
      <div>
        <SectionHeader
          ...
          detailLabel={t.detail.view_detail}
          onDetailClick={() =>
            handleSynastryDetailClick("asteroids", context, {
      ...
      <div>
        <SectionHeader
          ...
          detailLabel={t.detail.view_detail}
          onDetailClick={() =>
            handleSynastryDetailClick("rulers", context, {
                          ...
                          {sweetSpots.map((s, i) => (
                            ...
                            >
                              ...
                              <div className="space-y-2 text-xs">
                                ...
                                <div>
                                  <div
                                    className={`${detailLabelClass} text-blue-500`}
                                  >
                                    {t.us.experience}
                                  </div>
                ...
                >
                  ...
                  {weatherForecast && (
                    <div className="space-y-6">
                      ...
                      >
                        <h4
                          className={`${detailLabelClass} text-blue-500 mb-1`}
                        >
                      ...
                      >
                        <h4
                          className={`${detailLabelClass} text-gold-500 mb-1`}
                        >
