// Article: Shadow Work Journal Prompts That Reveal Root Wounds, Not Just Feelings
...
export const shadowWorkJournalPromptsEn: WikiArticle = {
  ...
  content: `# Shadow Work Journal Prompts That Reveal Root Wounds, Not Just Feelings
...
| Property | How It Works | Structural Focus | How to Observe |
|---|---|---|---|
| Projection mapping | Surfaces disowned qualities through the emotional charge in reactions to others | Shadow complex (Jung) | Journal entries where judgment of others carries unusual intensity or certainty |
| Behavioral incongruence | Tracks the gap between stated values and actual behavior under pressure | Source pattern vs. symptom | Recurring choices that contradict self-description across different situations |
| Source-moment tracing | Locates the first occurrence of a defensive pattern in memory | Childhood-to-adult continuity | Earliest memory carrying the same emotional quality as a current recurring reaction |
| Integration writing | Converts shadow material into acknowledged, usable personality traits | Ego–shadow relationship | Reduced charge when encountering the original trigger after working the prompt |
