// Article: What a Full Moon Ritual Really Does in the 48 Hours After
...
export const whatIsAFullMoonRitualEn: WikiArticle = {
  ...
  content: `# What a Full Moon Ritual Really Does in the 48 Hours After
...
1. **Full moon ritual vs new moon ritual.** A new moon practice is forward-facing — you plant intention into darkness and wait. The full moon practice is backward-facing — you name what you are releasing because the light has already shown you what no longer fits. To get the clarity of release, you sacrifice the open-ended hope of the new moon's blank-page energy. The two are designed to work as a pair across the cycle; if you set an intention with [new moon journal prompts](/en/wiki/new-moon-journal-prompts), the full moon ritual two weeks later is where you check what it produced and let go of what it didn't.

2. **Full moon ritual vs manifestation journaling.** Manifestation journaling works through repetition and emotional saturation; it does not require timing. A full moon ritual works through compression — a single high-charge window that forces a decision. To get the intensity of one decisive evening, you sacrifice the steady, low-grade reinforcement that daily journaling provides.

3. **Full moon ritual vs shadow work.** Shadow work, in the lineage Howard Sasportas drew from, is slow excavation across months or years. A full moon ritual is a checkpoint, not an excavation. To get the satisfaction of a clean ritual marker, you sacrifice the depth that only long-form psychological work delivers.
...
Before the full moon is exact, get clear on the single thing you are releasing. Not five things — one. Write it in a sentence you can say out loud without a paragraph of qualifiers: "I'm releasing the belief that rest has to be earned," not "I want to feel less stressed and more balanced and also be kinder to myself." Vague intentions do not survive contact with the days that follow. This pre-work is the part most people skip, and it is the part that decides everything else. If you are not sure what to release, a few minutes with [full moon journal prompts](/en/wiki/full-moon-journal-prompts) will usually surface it.
...
| Property | How It Works | Lunar Anchor | How to Observe |
|---|---|---|---|
| Release intention | Names a single thing to let go, out loud or in writing | Peak full moon night | Practitioner can state the release in one sentence with no qualifiers |
| Reclamation intention | Names what fills the cleared space | Same night, immediately after release | Practitioner names reclamation as a concrete behavior, not an abstract feeling |
| Ceremonial tools | Sharpen focus on intention; not the source of effect | Optional layer, any time during ritual | Removing the tools would not change the core of the practice |
...
- [New moon journal prompts](/en/wiki/new-moon-journal-prompts) — the forward-facing counterpart you pair with the full moon ritual two weeks later.
- [Full moon June 2026](/en/wiki/full-moon-june-2026) and [full moon July 2026](/en/wiki/full-moon-july-2026) — sign-by-sign context for the next two full moons' specific release themes.
