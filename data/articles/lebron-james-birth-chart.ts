// Article: What the LeBron James Birth Chart Reveals About His Drive and Legacy
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const lebronJamesBirthChartEn: WikiArticle = {
  slug: "lebron-james-birth-chart",
  image: "/images/blog/lebron-james-birth-chart.jpg",
  image_alt: "Planetary orbs arcing over a mountain ridge at night, symbolising LeBron James's full birth chart as a whole sky pattern",
  title: "What the LeBron James Birth Chart Reveals About His Drive and Legacy",
  description: "The LeBron James birth chart is a full map of where the Sun, Moon, and planets sat at the moment of his birth on December 30, 1984, read as an interpretive portrait rather than a forecast.",
  ...
  content: `# What the LeBron James Birth Chart Reveals About His Drive and Legacy
...
![Two-column comparison of the Sun-sign shortcut against a full birth chart portrait, showing trade-offs in speed vs depth](/images/blog/lebron-james-birth-chart-i0-en.svg)
...
![Five sequential steps for reading a birth chart as a character portrait, from finding the loudest theme to holding houses loosely](/images/blog/lebron-james-birth-chart-i1-en.svg)
...
![Four common misreadings of the LeBron James birth chart, each paired with the honest corrective read](/images/blog/lebron-james-birth-chart-i2-en.svg)

## The LeBron James Chart at a Glance

| Property | How It Works | Energy Center | How to Observe |
|---|---|---|---|
| Capricorn Sun | Drives long-term ambition and structure | Earth element, career-and-legacy themes | Relentless goal-setting and open talk of legacy |
| Planet clusters | Concentrate energy in one life area | Element weighting of the whole chart | Repeated focus on a single domain over years |
| Defining aspects | Link planets into a recurring theme | Cardinal, initiating mode | A signature tension that resurfaces over time |
| Debated Ascendant | Frames the public "mask" | Depends on the exact birth time | Rising-sign claims vary by source — hold them loosely |
