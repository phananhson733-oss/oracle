...
export const purpleAuraMeaningEn: WikiArticle = {
  ...
  image_alt:
    "purple aura energy field around a faint human silhouette, intuition and perception",
...
| --- | --- | --- | --- |
| Light purple / lavender | Soft inward attention, openness to felt-sense before words | Crown-leaning, with some third eye | Read as "psychic gift" when it is actually quiet interpretive openness |
| Mid purple | Steady symbol- and meaning-seeking orientation | Crown and third eye blend | Read as "old soul" rank when it is just an attentional tilt |
