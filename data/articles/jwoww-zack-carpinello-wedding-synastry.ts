...
This JWoww and Zack wedding astrology reading is easy to flatten if it turns into celebrity gossip, generic Pisces-Sagittarius compatibility, or a claim about hidden motives. The better approach is to keep each correction tied to what can actually be read from public data.
