// Article: What Tom Brady's Birth Chart Reveals About Drive and Temperament
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const tomBradyBirthChartEn: WikiArticle = {
  slug: "tom-brady-birth-chart",
  image: "/images/blog/tom-brady-birth-chart.jpg",
  image_alt: "Editorial illustration of a football quarterback under a glowing Leo constellation sky, evoking Tom Brady's Leo Sun birth chart",
  title: "What Tom Brady's Birth Chart Reveals About Drive and Temperament",
  description: "The Tom Brady birth chart is a symbolic map of where the Sun, Moon, and planets sat in the sky at his birth on August 3, 1977, in San Mateo, California.",
  authorId: "marcus-orion",
  date: "2026-07-18",
  schema: "Article",
  lang: "en",
  keywords: [
    "Tom Brady birth chart",
    "Tom Brady birth chart meaning",
    "Tom Brady birth chart astrology",
    "Tom Brady birth chart zodiac",
    "Tom Brady birth chart interpretation"
  ],
  content: `# What Tom Brady's Birth Chart Reveals About Drive and Temperament
...
![Five-step sequence for reading Tom Brady's birth chart placements from Leo stack to skipping unverifiable houses](/images/blog/tom-brady-birth-chart-i0-en.svg)
...
|---|---|---|---|
| Sun in Leo | Anchors identity in pride, visibility, and self-expression | Fire | Notice a pull toward being seen for the quality of the work |
| Saturn in Leo | Adds discipline and restraint to that Leo self-expression | Fire | Look for showmanship that is measured rather than loose |
| Mars & Jupiter in Gemini | Drives restless mental energy, quick strategy, and curiosity | Air | Watch for thinking out loud and an appetite for information |
| Mercury in Virgo | Shapes a precise, detail-editing style of thinking | Earth | Spot careful, corrective focus under the bold surface |
| Moon in Pisces (approx) | Colors emotional life with sensitivity; near a boundary, so tentative | Water | Hold loosely; without a birth time it may shift |


![Comparison table of Tom Brady's five key birth chart placements, their core energy, and astrological element](/images/blog/tom-brady-birth-chart-i1-en.svg)
...
- [Tom Brady (Wikipedia)](https://en.wikipedia.org/wiki/Tom_Brady) — the public record behind the birth data used here.
