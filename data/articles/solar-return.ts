// Article: What a Solar Return Really Highlights in Your Year Ahead
...
|---|---|---|---|
| Resets annually | Recast each birthday when the Sun reaches its natal degree | The natal Sun's exact sign and degree | Note the year runs birthday to birthday, not January to December |
| Temporary overlay | Activates existing potential for twelve months, then expires | The whole birth chart it rests on top of | Compare each placement to its natal counterpart |
| Year's focus area | The return Sun's house shows where the spotlight falls | The natal house holding that same theme | Locate the Sun's house in the annual chart |
| Yearly tone | The return Ascendant colors how the year is met | The natal rising sign it temporarily overlays | Check the rising sign of the birthday chart |
