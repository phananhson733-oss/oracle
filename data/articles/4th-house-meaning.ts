// Article: The 4th House Meaning Behind Your Emotional Foundation
...
export const fourthHouseMeaningEn: WikiArticle = {
  ...
  content: `# The 4th House Meaning Behind Your Emotional Foundation
...
3. **The polarity gap.** People read the 4th house alone and overlook how it balances the [explainer on the 10th house and public ambition](/en/wiki/astrology-houses) at the top of the chart.
...
| --- | --- | --- | --- |
| Emotional foundation | Sets your baseline sense of safety and trust | Cancer / the Moon (Water) | Notice where you instinctively retreat under stress |
| Family inheritance | Carries patterns and conditioning from early life | IC / base of the chart | Spot habits that quietly echo a parent's |
| Roots and belonging | Anchors where you feel you are "from" | Water element | Track what makes a place finally feel like home |
| Private self | Holds the self that lives beneath public roles | Lower hemisphere of the chart | Compare who you are at home versus in public |
...
export const fourthHouseMeaningZh: WikiArticle = {
  ...
  content: `# 第四宫代表什么，远不止你住的那个家

## The 4th House 是什么？

The 4th House（第四宫）是本命盘里位于星盘底部的宫位，也叫天底（IC，Imum Coeli）。它在传统占星教学里被当成整张星盘的地基，和 [占星十二宫总览 pillar 页](/zh/wiki/astrology-houses) 里讲的整体框架一脉相承，记录你童年时期关于"安全"和"归属"的感受。所以问第四宫代表什么，答案不是你名下那套房子，而是**一个人情感根基与家庭底色的所在**。
...
- [第十宫与社会角色详解](/zh/wiki/astrology-houses) — 第四宫的私领域根基，正好和第十宫的公领域成就构成一条轴线。
- *巨蟹座性格与情感模式* — 第四宫的自然守护星座，能帮你理解"根"的水象基调。
- *天底 IC 在星盘里的意义* — 想从星盘结构上看懂第四宫的起点，可以从天底切入。
