// Article: What 10th House Astrology Reveals About Your Public Role
...
| Property | How It Works | Energy & Ruling Sign | How to Observe |
|---|---|---|---|
| Public role | Shows the standing and reputation you build over time | Capricorn / Saturn | Notice the role strangers assume you already hold |
| Vocation | Points to the direction authority grows, not one fixed task | Capricorn / Saturn | Track the responsibilities you keep being handed |
| Earned authority | Granted slowly through tested competence, never at birth | Capricorn / Saturn | Watch where you are trusted to make the final call |
| Midheaven (MC) | Marks the most visible, public-facing point of the chart | Cardinal earth | Look at how you are introduced or described in public |
...
- [guide to the 4th house and private roots](/en/wiki/astrology-houses) — the private counterpart that sits directly opposite the 10th on the same axis.
- *guide to the Saturn return and earned authority* — how the planet behind the 10th house reshapes public life over time.
- [House (astrology) (Wikipedia)](https://en.wikipedia.org/wiki/House_(astrology)) — a neutral reference on the house framework itself.
...
export const tenthHouseAstrologyZh: WikiArticle = {
  ...
  content: `# 第十宫说的从来不是职业头衔，而是你正在长成的公众角色

## The 10th House 是什么？

The 10th House（第十宫）是星盘里代表公众角色与社会身份的区域。它从天顶（MC，Midheaven，星盘最高点）起算，自然对应摩羯座与土星的主题——责任、结构，以及你愿意为之负长期责任的位置。想把它放回更大的框架里看，可以先读 [占星十二宫总览 pillar 页](/zh/wiki/astrology-houses)，那里梳理了每个宫位各自管哪一块人生。第十宫真正描述的，是**你正在长成的那种公众角色**。
...
- *天顶 MC 含义说明* — 第十宫的起点，单独读能更准地看出你的公众方向。
- [第十宫宫主星落点指南](/zh/wiki/astrology-houses) — 想知道第十宫的能量最后流向哪里，就追它的宫主星。
