// Article: Reading Justin Verlander's Birth Chart Through an Early Pisces Sun
...
export const justinVerlanderBirthChartEn: WikiArticle = {
  ...
  image_alt: "Deep blue stadium light over a flowing Pisces-inspired water motif for Justin Verlander's early Pisces Sun reading",
  title: "Reading Justin Verlander's Birth Chart Through an Early Pisces Sun",
  description: "The safest Justin Verlander birth chart reading starts with a narrow, verifiable fact: he was born on February 20, 1983, in Manakin Sabot, Virginia, and his Sun is in the opening degrees of Pisces.",
  ...
  content: `# Reading Justin Verlander's Birth Chart Through an Early Pisces Sun
...
| Chart Layer | Can We Use It? | Responsible Reading |
| --- | --- | --- |
...
| Placement | Meaning in This Reading | What to Avoid |
| --- | --- | --- |
