// Article: What the Harry Styles and Zoë Kravitz Air-Fire Sextile Really Shows
...
export const harryStylesAndZoKravitzEn: WikiArticle = {
  ...
  content: `# What the Harry Styles and Zoë Kravitz Air-Fire Sextile Really Shows
...
For Harry Styles and Zoë Kravitz, this is the frame sitting underneath the headlines: his Aquarius air and her Sagittarius fire form the sextile that any careful [pillar page on synastry compatibility basics](/en/wiki/synastry-chart-compatibility) would read before ever reaching for a single number. His Sun leans toward open, conceptual independence, while hers leans toward candor and motion — two signatures that, a sextile apart, tend to feed each other rather than compete.
...
![Side-by-side comparison of reading the air-fire sextile versus relying on a compatibility percentage score](/images/blog/harry-styles-and-zo-kravitz-i1-en.svg)
...
1. **Find the elements first.** Confirm one partner leads with an air sign (here, Aquarius) and the other with a fire sign (Sagittarius); a sextile forms between same-polarity elements.
2. **Check the angle.** A sextile sits roughly 60 degrees apart — two placements about two signs apart, give or take a few degrees, are doing sextile work.
3. **Watch how distance feels.** Air-fire sextiles often read as comfortable space, with partners lighting up around each other's plans instead of policing the gaps.
...
5. **Look past the Sun.** Robert Hand's approach to synastry treats Moon, Venus, and Mars contacts as where the real relating happens, so let a Sun-sign sextile open the read, not close it.
...
![Five-step sequence for identifying the Aquarius–Sagittarius air-fire sextile in a synastry chart](/images/blog/harry-styles-and-zo-kravitz-i0-en.svg)
...
![Five common misreadings of the Aquarius–Sagittarius air-fire sextile paired with the accurate interpretation](/images/blog/harry-styles-and-zo-kravitz-i2-en.svg)
...
[Generate your free birth chart to read the air-fire sextile](https://astrologywiki.com/en/wiki/how-to-read-birth-chart)
