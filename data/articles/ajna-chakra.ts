...
Ajna Chakra（眉心轮，又称第三眼脉轮）是脉轮（chakra，西方瑜伽与灵性传统里的能量中心概念）体系里的第六个中心，位置在两眉之间、眉心略上方。说眉心轮代表什么，最贴切的一句是：**它是内在觉知与清晰辨别的中心**。在较早的瑜伽说法里，它被描述为两条能量通道交会、再上行到顶轮之前的那个点。沿着 Anodea Judith 系统化的现代脉轮框架来看，更实用的理解是：它是你还说不清理由、却先察觉到某个苗头的那部分；随后它会把这份直觉拿去和你真正知道的事对照。这一切都属于更上位的 [脉轮系统总览 pillar 页](/zh/wiki/chakra-system-overview)，那里梳理了每个中心之间的关系。
