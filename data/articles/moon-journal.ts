...
[Generate your free birth chart](/en/birth-chart-calculator) to see how your natal moon sign shapes which phase of a moon journal comes most naturally to you. Your moon placement describes whether intention-setting, obstacle-tracking, evaluation, or release tends to be your default mode of self-reflection — and which function you are most likely to skip or abbreviate. That gap between where your natal moon is strong and the phase you tend to avoid is often where the most revealing journaling across cycles happens.
