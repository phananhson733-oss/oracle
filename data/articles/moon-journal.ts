// Article: What a Moon Journal Actually Tracks Across Four Phases
...
1. **"Write about the moon's energy."** Atmospheric writing about lunar symbolism is not the practice — the phase function is. Writing poetically about the full moon's light doesn't constitute a culmination review. The phase prompts the written task; describing the phase is optional decoration, not the substance.

2. **"Track your emotions across the cycle."** Emotion tracking is one output of a functioning practice, not its framework. The journal tracks intentions against outcomes; emotions are data within that evaluation process. Treating emotional documentation as the goal removes the evaluative structure and leaves a mood record organized by lunar date rather than a feedback loop.

3. **"The full moon is when to release."** Release belongs to the waning phase, not the full moon. The full moon's designated function is honest assessment: what actually came to fruition versus what was wishful projection. Moving release to the full moon compresses two distinct functions into one undifferentiated entry — the result is that neither evaluation nor release is done well.

4. **"Any journaling timed to the moon counts."** The feedback loop only activates when each phase uses its designated function. Journaling near moon dates without phase-differentiated prompts is general journaling on a lunar schedule. The phases provide the structural framework; without it, the cumulative tracking value never accumulates across cycles.

## Moon Phases at a Glance

| Phase | How It Works | Psychological Function | How to Observe |
|---|---|---|---|
| New Moon | Write a specific intention, goal, or decision to activate over the coming 28-day cycle | Anchoring — commits attention and direction before momentum builds | Entry reads like a commitment or target, not a mood reflection |
| Waxing | Identify by name what is slowing the intention — competing demands, habit patterns, resource gaps | Tracking — surfaces resistance before it derails the cycle | Entry names specific friction, not general progress updates |
...
1. Name the last goal you set at a new moon: did your full moon entry show it actually happened?
2. Name one obstacle from a recent waxing phase that you avoided writing down, and what it cost you.
3. What expectation did you carry into your last new moon that should have been released at the prior waning phase?
...
[Generate your free birth chart](https://astrologywiki.com/en/wiki/how-to-read-birth-chart) to see how your natal moon sign shapes which phase of a moon journal comes most naturally to you. Your moon placement describes whether intention-setting, obstacle-tracking, evaluation, or release tends to be your default mode of self-reflection — and which function you are most likely to skip or abbreviate. That gap between where your natal moon is strong and the phase you tend to avoid is often where the most revealing journaling across cycles happens.
