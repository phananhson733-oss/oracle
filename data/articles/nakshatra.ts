// Article: What Nakshatra Tells You About Timing That Your Sun Sign Cannot
...
export const nakshatraEn: WikiArticle = {
  ...
  content: `# What Nakshatra Tells You About Timing That Your Sun Sign Cannot
...
| Station | How It Works | Ruling Planet | How to Observe |
|---|---|---|---|
| Rohini | Associated with growth, sensory richness, and the drive to sustain what feels nourishing; tends to intensify attachment to abundance | Moon | During Rohini periods, notice where the desire to hold onto what feeds you creates friction — the pull toward comfort that resists necessary change |
| Bharani | Linked to containment, transformation, and the threshold between one form and another; carries themes of creative gestation under pressure | Venus | Bharani periods often surface as a sense of holding something difficult before release — watch for what needs to be let go before something new can form |
