// Article: Revati Nakshatra, the 27th and Final Lunar Mansion, Explained
...
export const revatiNakshatraEn: WikiArticle = {
  ...
  content: `# Revati Nakshatra, the 27th and Final Lunar Mansion, Explained
...
| Property | What It Means | Where It Sits | How to Read It |
| --- | --- | --- | --- |
| Cycle position | 27th and final lunar mansion | 16°40'–30° Pisces, the wheel's last degrees | Completion that touches a fresh beginning |
...
export const revatiNakshatraZh: WikiArticle = {
  ...
  content: `# 走到黄道尽头的瑞瓦蒂，把"结束"读成了一次被护送的渡口

## 瑞瓦蒂星宿是什么?

瑞瓦蒂星宿是**吠陀占星二十七宿里的第二十七个、也是最后一个月宿，落在双鱼座的末段，由水星主管，由牧者之神普善（Pushan）守护，专管在终结与新生之间安全过渡的那一段路**。它坐在黄道之轮的最边缘，一整圈在这里走完，下一圈又在这里悄悄开始。多数人翻到它，预期会撞上一种沉重的、落幕式的能量，读下来却发现一种更轻、也更奇怪的味道：这是一处"越过去"的地方，而不是"关上门"的地方。想知道它在你自己的星盘落在哪一格，*nakshatras 集群支柱页*这类内容把二十七个月宿如何环环相扣讲得最清楚。
...
把瑞瓦蒂星宿放到轮盘上的两个邻居旁边，会看得更清楚。对比开篇那一宿娄宿（Ashwini），它是一面镜像：娄宿以最原初的发动能量猛然炸开，它则以圆满的平静收束，两者共享同一道地平线，因为这一圈的终点正贴着下一圈的起点。取舍是脾性上的——娄宿的天赋是开端的火花，它的天赋是把事情好好收尾的从容，同一个动作里你没法把两者全占。
...
3. 引入普善作为牧者与护送者的角色，围绕"安全过渡"和"滋养式地护佑他人"来定位这个落点。
...
- *nakshatras 集群支柱页* —— 把二十七个月宿如何彼此相连讲清楚的中枢页
- 开篇那一宿娄宿（Ashwini）—— 这圈起点处的那面镜子，正被这一宿的收尾轻轻触到
