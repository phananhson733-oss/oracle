// Article: What Moon in Capricorn Reveals About Your Emotional World
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const moonInCapricornEn: WikiArticle = {
  slug: "moon-in-capricorn",
  image: "/images/blog/moon-in-capricorn.jpg",
  image_alt: "A lone mountain peak under a full moon in deep indigo sky, evoking Moon in Capricorn's guarded emotional depth",
  title: "What Moon in Capricorn Reveals About Your Emotional World",
  description: "Moon in Capricorn is a natal placement where the Moon — the part of the chart tied to emotions, instincts, and what makes a person feel safe — sits in the earth sign Capricorn.",
...
![Five key traits that reveal a Moon in Capricorn placement in a birth chart](/images/blog/moon-in-capricorn-i0-en.svg)
...
![Comparison of four common misconceptions about Moon in Capricorn against their astrological reality](/images/blog/moon-in-capricorn-i1-en.svg)

## Moon in Capricorn at a Glance

| Property | How It Works | Astrological Basis | How to Observe |
| --- | --- | --- | --- |
| Emotional default | Feelings are processed privately and shown through steadiness | Moon in detriment | Calm, contained responses even in genuinely stressful moments |
| Ruling influence | Saturn lends structure, patience, and a sense of duty | Saturn rulership | A pull toward responsibility and long-term goals |
| Source of comfort | Safety is tied to competence, order, and self-reliance | Cardinal earth | Reassurance from plans, routines, and feeling capable |
| Under stress | Doubles down on control and quietly carries the load | Saturn rulership | Taking on more alone instead of asking for help |
