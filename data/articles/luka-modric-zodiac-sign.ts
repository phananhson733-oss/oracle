// Article: What the Luka Modric Zodiac Sign Reveals About Croatia's Quiet Genius at 40
...
export const lukaModricZodiacSignEn: WikiArticle = {
  ...
  content: `# What the Luka Modric Zodiac Sign Reveals About Croatia's Quiet Genius at 40

## What Is Luka Modric's Zodiac Sign?

Luka Modric's zodiac sign is Virgo, anchored by a Sun in Virgo and a Moon in Cancer. Born on September 9, 1985, the Croatian captain falls squarely in Virgo season, and within the wider [World Cup 2026 astrology prediction hub](/en/wiki/world-cup-2026-astrology-prediction) his chart stands out for what it leaves unsaid — including his birth time, which has never been made public. Astrologers reading the Luka Modric zodiac sign sum it up as **a Virgo Sun paired with a Cancer Moon**, with Scorpio the rising sign most often attributed to him — though without a confirmed birth time that ascendant stays unverified, and other sources cite Cancer or Libra instead.
...
In eight years of aura-reading and energy work — with a background in advertising and somatic therapy training — I've watched people get reduced to a single headline trait, and it almost never holds up. Reading the whole field instead of one label is the approach practitioners like Barbara Ann Brennan and Cyndi Dale built their work around, and it applies cleanly here: Modrić's Virgo precision and Cancer loyalty — plus the Scorpio composure many readers attribute to him — only make sense as a set. That fuller picture is exactly what a sign-by-sign breakdown such as the [best soccer players by zodiac sign](/en/wiki/best-soccer-players-zodiac-sign) is for.
...
- [Luka Modrić (Wikipedia)](https://en.wikipedia.org/wiki/Luka_Modri%C4%87) — confirms the birth data the chart is built on.
