// Article: Journal Prompts That Actually Surface Patterns vs. the Ones That Fill Pages
...
export const journalPromptsEn: WikiArticle = {
  ...
  content: `# Journal Prompts That Actually Surface Patterns vs. the Ones That Fill Pages
...
2. **Multiple situations vs. one event.** Diagnostic prompts ask for several instances, not one memory. "Think of three times you agreed when you meant to say no" requires cross-situational recall. "Write about a time you felt pressured" anchors in a single memory and tends toward narrative.

3. **Behavioral evidence vs. emotional report.** "What did you actually do?" is diagnostic. "How did it affect you?" is narrative. The first requires naming a specific action; the second invites elaboration on a feeling. Both are valid questions — only the first consistently produces new pattern data.

4. **Hesitation as a signal.** Prompts that produce immediate, fluent writing often sit inside territory you've already articulated to yourself. Questions that feel unexpectedly hard to answer concretely — where you find yourself substituting interpretation for a specific instance — are more likely touching unexamined material.
...
3. **"Prompts about anxiety help you understand the pattern."** Prompts built around anxiety are often designed for emotional expression and release. A question asking "What worries are you carrying today?" invites description of a current emotional state. "In which situations do you consistently prepare for the worst, even when the stakes are demonstrably low?" is structurally more useful — it requires behavioral comparison across situations rather than description of the present moment. Expression and pattern detection serve different purposes, and conflating them leads to months of expressive writing that leaves the underlying pattern unchanged.

4. **"Hesitation means the prompt is wrong for you."** Blank-page discomfort in response to a well-formed prompt usually means the prompt is working. Diagnostic questions asking for specific behavioral instances feel harder than narrative prompts because they require naming what you did, not what you felt or intended. That friction is informational, not a sign the question doesn't fit.

## Prompt Structure at a Glance

| Property | How It Works | Energy Center | How to Observe |
|---|---|---|---|
| Topic-organized | Groups inquiry by emotional theme; invites description of a named feeling or life domain | Emotional expression | Fluent, immediate writing; high word count with limited new pattern data |
| Diagnostic | Anchors inquiry across multiple situations; requires behavioral evidence over emotional report | Pattern recognition | Hesitation before writing; difficulty naming specific instances often signals proximity to unexamined material |
| Shadow work | Inverts habitual self-view to surface avoided or disowned material by targeting the gap between self-image and actual behavior | Unconscious avoidance | Strong resistance or quick deflection toward abstraction both indicate material worth staying with |
| Self-discovery | Spans life domains (work, relationships, inner life) to surface behavioral consistency across contexts | Cross-domain observation | Patterns appearing across more than one domain are the usable signal; single-domain answers suggest narrative framing |
