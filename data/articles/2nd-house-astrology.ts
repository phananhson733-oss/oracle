// Article: How 2nd House Astrology Links Your Money to a Deeper Sense of Worth
...
export const secondHouseAstrologyEn: WikiArticle = {
  ...
  content: `# How 2nd House Astrology Links Your Money to a Deeper Sense of Worth
...
This house belongs to the broader [pillar guide to the twelve astrological houses](/en/wiki/astrology-houses), which maps how each life area connects to the next. Where the 1st house asks "who am I," the 2nd house asks "what is mine, and what do I value enough to keep." Reading it well means treating money as evidence of an inner relationship, not just a balance in an account.
...
|----------|--------------|---------------|----------------|
| Core theme | Links material security to self-worth | Ruled by Venus, earthy Taurus | Notice where money and self-esteem rise and fall together |
| Natural sign | Taurus lends steadiness and attachment | Earth element, fixed mode | Watch for slow, deliberate handling of what you own |
| Resources held | Defines what is yours alone to earn and keep | 2nd of twelve houses | List the assets you feel are truly "mine" |
| Polarity | Balances personal worth against shared resources | Opposes the 8th house | Compare what you hold solo versus what you merge |
...
- [House (astrology) (Wikipedia)](https://en.wikipedia.org/wiki/House_(astrology)) — context on how astrological houses are defined and numbered
...
export const secondHouseAstrologyZh: WikiArticle = {
  ...
  content: `# 第二宫真正在说的，是你觉得自己值多少

## The 2nd House 是什么？

The 2nd House（第二宫）是星盘里掌管金钱、资源与自我价值感的宫位。它紧跟在上升点之后，与 [占星十二宫总览 pillar 页](/zh/wiki/astrology-houses) 同属一套框架，那份总览梳理了每个宫位各自负责的人生领域。很多人把第二宫读成"赚钱的宫位"，可第二宫代表什么，落点其实不在数字，而在你如何对待手里的资源、资源的多寡又如何牵动你对自己的评价。在主流占星里，它对应金牛座的能量调性，关心的是"什么让我感到稳定、什么让我觉得有价值"。说到底，第二宫记录的是**你与拥有、与价值感相处的方式**。
...
1. **第二宫 vs 第八宫。** 第二宫管"我自己挣来、自己拥有"的资源，运作上偏向积累与守成；第八宫则管 [第八宫与共享资源解读](/zh/wiki/8th-house-meaning) 里那种共享、继承、与他人交缠的钱。你越是把安全感全押在"我的"东西上，就越难松手去经营"我们的"那部分。
...
- *金星与个人价值观解读* — 想分清"喜欢什么"和"留下什么"，可以对照金星与第二宫的差别。
- [金牛座能量特质指南](/zh/wiki/north-node-in-taurus) — 第二宫与金牛座同调，了解金牛能量有助于读懂安全感的来源。
- *上升点与星盘起点说明* — 第二宫紧接上升点，先理解上升点能让宫位顺序更清晰。
