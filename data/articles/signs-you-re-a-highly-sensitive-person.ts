// Article: Spotting the Real Signs You're a Highly Sensitive Person
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const signsYouReAHighlySensitivePersonEn: WikiArticle = {
  slug: "signs-you-re-a-highly-sensitive-person",
  title: "Spotting the Real Signs You're a Highly Sensitive Person",
  description: "Signs of a highly sensitive person are the consistent patterns of deep processing, strong empathy",
  authorId: "elena-vane",
  date: "2026-06-02",
  schema: "Article",
  lang: "en",
...
2. **Sensitivity vs autism.** The two share surface signs, especially sensory overwhelm and a love of routine, which is why the [comparison of highly sensitive person and autism](/en/wiki/highly-sensitive-person-vs-autism) is worth reading slowly. Underneath, the way it works differs: autism centers on social communication and pattern, sensitivity on depth of feeling — so to gain one tidy label you sacrifice accuracy, since the two can also coexist in the same person.
...
|---|---|---|---|
| Sensory sensitivity | Takes in more raw input before filtering it, so stimulation stacks up faster than usual | Solar plexus | You leave loud or bright places wrung out while others seem unbothered |
| Emotional attunement | Reads and absorbs the feelings around you, often before they are spoken | Heart | You catch a friend's mood shift before they say anything is wrong |
| Deep processing | Turns each experience over slowly and thoroughly instead of skimming it | Third eye | You replay conversations and decisions long after everyone else has moved on |
| Need for recovery | Restores balance through quiet, solitude, and low stimulation | Root | You crave hours alone after a packed, social, or conflict-heavy day |
...
export const signsYouReAHighlySensitivePersonZh: WikiArticle = {
  slug: "signs-you-re-a-highly-sensitive-person",
...
这种气质在心理学里被称为感官加工敏感（sensory processing sensitivity，指神经系统对刺激的反应阈值更低）。想先看清它的全貌，可以从 *高敏感人群完整指南 pillar 页* 入手。它是一种与生俱来的底色，不是缺陷，也不是病。判断高敏感人群特征，关键不在于某一天累不累，而在于这组反应是否长期、稳定地出现在你身上。
...
和自闭谱系比：两者都对感官输入敏感，有几个信号确实重叠，所以容易被搞混。差别在运作机制——自闭谱系还牵涉社交沟通和重复行为模式，高敏感主要是加工深度和情绪共情更强。想看清这几个重叠信号分别指向什么，可以对照 [高敏感与自闭谱系的区别](/zh/wiki/highly-sensitive-person-vs-autism)。要在生活里只用「敏感」一个词去解释所有不适，你换来了简单，却会失掉判断的准头。
...
- [占星第十二宫解读](/zh/wiki/12th-house-astrology) —— 很多高敏感人会在这个代表内在、隐秘世界的宫位里，读到那种容易被外界渗透的特质。
