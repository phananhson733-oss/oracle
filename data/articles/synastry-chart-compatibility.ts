// Article: Why Your Synastry Chart Compatibility Score Misses the Point
...
export const synastryChartCompatibilityEn: WikiArticle = {
  ...
  content: `# Why Your Synastry Chart Compatibility Score Misses the Point
...
This reading sits within the broader [pillar page on how to read a birth chart](/en/synastry-calculator), which covers the foundational chart language synastry draws on. Synastry chart compatibility treats the relationship itself as the subject of analysis — not either person in isolation — reading what arises when two whole charts interact across their full range of placements.
...
2. **Synastry vs. composite charts.** The composite averages the midpoints of two natal charts to produce a third synthetic chart representing the relationship as an entity. Where synastry chart compatibility shows who is doing what to whom — whose Saturn is landing on whose Moon, whose Pluto is opposing whose Venus — the composite shows the relationship's character without specifying directionality. To get the composite's relationship-as-subject perspective, you lose the inter-chart activation detail that identifies which patterns belong to which person and which direction the pressure runs.

3. **Synastry vs. Davison chart.** The Davison calculates a literal birth moment — a time-place midpoint between two sets of birth data — producing a chart with an astronomical anchor that can itself receive transits. The trade-off mirrors the composite: you gain a chart useful for timing but sacrifice the activation-point map that shows which inter-chart contacts carry the most weight right now.
...
2. **Saturn inter-chart contacts.** Where one person's Saturn aspects another's personal planet, the aspect type shapes the pattern. A Saturn trine to someone's Moon tends to add steadiness; a Saturn square to Venus may surface a pattern where affection feels earned rather than freely given.

3. **Pluto inter-chart contacts.** Pluto aspecting a personal planet in another chart tends to activate buried psychological material — power, transformation, deep-pattern recognition. The contact often reads as intensity early on and, over time, as clarifying pressure rather than threat.

4. **House overlays.** Check which house each of your planets occupies in the other person's chart. Your Venus in someone's seventh house registers as a visible relational presence; the same Venus in their twelfth becomes more private and internalized — felt but not always named by either person.
...
2. **"Saturn contacts are warning signs."** In most practitioners' readings, Saturn contacts between charts are treated as stabilizing forces — the contacts that keep people engaged through difficulty rather than moving on when friction peaks. Jeffrey Wolf Green's approach to synastry treats Saturn inter-chart contacts as specific developmental agreements two people have arranged, not obstacles to compatibility.

3. **"Incompatible sun signs can't work."** Sun-sign incompatibility describes a difference in core expression style, not a relational outcome. Full synastry analysis frequently shows that rising sign, Moon, and Venus contacts across "incompatible" sun signs carry more relational resonance than the surface-level sign pairing suggests.

4. **"A Pluto contact means the relationship will be destabilizing."** Pluto contacts in synastry tend to surface depth and psychological material that might otherwise stay below awareness. That intensity can read as disorienting at first and clarifying over time — many long-term relationships carry at least one significant Pluto contact alongside their easier aspects.

## Synastry Chart Compatibility at a Glance

| Property | How It Works | Aspect Type | How to Observe |
|---|---|---|---|
| Venus-Mars conjunction | One person's desire nature activates the other's action drive; primary attraction signal | Conjunction (0–5°) between personal planets | Notice a pull toward each other's company that feels energizing rather than neutral |
| Saturn square or opposition | One person's structuring energy creates friction against the other's personal planet; long-term developmental contact | Square (90°) or opposition (180°) involving Saturn | Notice where one person tends to feel tested, held to account, or asked to prove reliability |
| Pluto opposition | One person's transformative energy meets the other's personal planet directly; surfaces buried patterns | Opposition (180°) involving Pluto | Notice where one person brings unexamined material to the surface for the other |
| Sun-Moon trine or conjunction | Core identity and emotional need find ease together; produces mutual recognition | Trine (120°) or conjunction (0°) between luminaries | Notice whether the other person's presence tends to settle your emotional baseline |
| House overlay (7th or 8th) | One person's planet lands in the other's relationship or intimacy house | Planet in the receiving chart's 7th or 8th house | Notice whether themes of partnership or depth come up naturally around that person |
...
- [Composite Chart Calculator](/en/wiki/composite-chart-calculator)
<!-- gg-cluster-links:end -->
- [guide to natal chart houses and their life areas](/en/wiki/astrology-houses) — house overlays in synastry become clearer once you understand what each house governs in a single chart
- [overview of lunar nodes and karmic path indicators](/en/wiki/north-node-vs-south-node) — some synastry readings weight nodal contacts as long-arc relational indicators alongside aspect contacts
- [Astrological compatibility (Wikipedia)](https://en.wikipedia.org/wiki/Astrological_compatibility)

## Take Action

[Generate your free birth chart](/en/synastry-calculator) to explore synastry chart compatibility. Once you have your natal chart in hand, you can place it alongside another person's chart and begin scanning the inter-chart contacts — identifying which aspects land closest in orb and where each of your planets falls in the other person's houses. The contacts you find often name patterns you've already sensed in the relationship but hadn't had language for.
