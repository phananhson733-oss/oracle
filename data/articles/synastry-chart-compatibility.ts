...
This reading sits within the broader [pillar page on how to read a birth chart](/en/wiki/how-to-read-birth-chart), which covers the foundational chart language synastry draws on. Synastry chart compatibility treats the relationship itself as the subject of analysis — not either person in isolation — reading what arises when two whole charts interact across their full range of placements.
