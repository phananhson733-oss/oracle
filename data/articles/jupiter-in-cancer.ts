// Article: What Jupiter in Cancer Really Says About How You Nurture and Grow
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const jupiterInCancerEn: WikiArticle = {
  slug: "jupiter-in-cancer",
  image: "/images/blog/jupiter-in-cancer.jpg",
  image_alt: "Jupiter glowing gold above a coastal home at twilight, symbolizing growth through nurturing and belonging in Jupiter in Cancer",
  title: "What Jupiter in Cancer Really Says About How You Nurture and Grow",
  description: "Jupiter in Cancer is the placement of Jupiter, the planet of growth and expansion, in Cancer, the sign of home, family, and emotional security, where a person tends to grow most through caring for others and building a felt sense of belonging.",
  ...
  keywords: [
    ...
    "jupiter in cancer astrology",
    "jupiter in cancer birth chart",
    "jupiter in cancer zodiac",
    "jupiter in cancer interpretation"
  ],
  content: `# What Jupiter in Cancer Really Says About How You Nurture and Grow
...
![Side-by-side comparison of Jupiter in Cancer and Moon in Cancer showing how each placement differs in a birth chart](/images/blog/jupiter-in-cancer-i0-en.svg)
...
![Five steps to read Jupiter in Cancer in your birth chart from locating the glyph to checking the house placement](/images/blog/jupiter-in-cancer-i1-en.svg)
...
|----------|--------------|---------------|----------------|
| Core drive | Expansion through care and belonging | Water element, Cardinal mode | You feel largest when nurturing others |
| Natural house | Growth tied to home and roots | Fourth house, ruled by the Moon | A steady pull toward family, home, and legacy |
| Strength | Emotional generosity and warmth | Cancer's protective instinct | People come to you for comfort |
| Shadow side | Over-giving and trouble detaching | Cardinal water's tidal pull | Your care outruns your own capacity |
...
- [Cancer (astrology) (Wikipedia)](https://en.wikipedia.org/wiki/Cancer_(astrology)) — background on the sign itself.
