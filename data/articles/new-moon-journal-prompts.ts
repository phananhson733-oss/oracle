// Article: New Moon Journal Prompts That Build Intentions Worth Tracking
...
| Prompt Layer | How It Works | Timing Window | How to Observe |
|---|---|---|---|
| External expectation | Names an observable outcome tied to the two-week lunar window | Set at the new moon, before the cycle builds | Re-read at the full moon: can you honestly confirm or deny it? |
| Internal shift | Identifies the belief or self-story that must update for the intention to be real | Set at the new moon alongside the outcome | Notice at the first quarter whether the old belief surfaces in your behavior |
