// Article: What Sam Neill's Birth Chart Says About His Craftsman Screen Persona
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const samNeillBirthChartEn: WikiArticle = {
  slug: "sam-neill-birth-chart",
  image: "/images/blog/sam-neill-birth-chart.jpg",
  image_alt: "Painterly portrait of a contemplative craftsman actor at a candlelit desk with Virgo wheat and Mercury's golden orbital arc in a deep indigo starfield",
  title: "What Sam Neill's Birth Chart Says About His Craftsman Screen Persona",
  description: "Sam Neill's Virgo natal chart is the astrological map tied to the actor born on September 14, 1947, in Omagh, and it centers on a Virgo Sun.",
...
2. **Craft over drama.** His chart makes the case that precision and restraint are a personality, the same instinct you might bring to your own [rising sign meaning explainer](/en/wiki/ascendant-meaning).
...
![Comparison of a quick Sun-sign snapshot against a full psychological birth chart reading for Sam Neill](/images/blog/sam-neill-birth-chart-i1-en.svg)
...
![Five-step sequence showing observable Virgo signals: craft, editing instinct, dry wit, reserve, and service to the material](/images/blog/sam-neill-birth-chart-i0-en.svg)
...
- [synastry compatibility overview](/en/wiki/synastry-chart-compatibility) — for readers moving from one chart to relationship comparisons.
