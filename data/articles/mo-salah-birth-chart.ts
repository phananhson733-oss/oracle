...
export const moSalahBirthChartEn: WikiArticle = {
  ...
  description: "Mohamed Salah's birth chart is the snapshot of the sky at the moment he was born on June 15, 1992, in Nagrig, Egypt — a Gemini Sun map that astrologers read as a chart built around shared momentum, not solo glory.",
