// Article: Why a Sextile Is an Open Door, Not a Free Gift
...
1. **Sextile vs trine.** A trine is a 120-degree angle where two planets cooperate with no effort at all, while a sextile asks for a small push first. To get the effortless flow of the [explainer on the trine aspect](/en/wiki/trine-in-astrology), you sacrifice the urgency to develop it, so the talent can sit unused; to get the sextile's growth, you sacrifice the comfort and have to make the first move.
...
- [overview of the major chart aspects](/en/wiki/astrology-terms) — for the full set of angles beyond the sextile covered here
- [Astrological aspect (Wikipedia)](https://en.wikipedia.org/wiki/Astrological_aspect) — for the technical background on how aspects are measured
...
export const sextileAstrologyZh: WikiArticle = {
  ...
  content: `# 六分相：一扇为你打开却要你自己走过去的门

## Sextile 是什么？

六分相（Sextile）是**两颗行星之间相隔 60 度、代表一种需要你主动把握的顺畅配合**。在星盘上，这两颗行星刚好相距整个圆盘的六分之一，近到彼此能轻松搭上线，又远到不会自己发生作用。很多人记住了符号和度数就停下了，于是这个词总是把人重新送回搜索框。它属于[占星术语总览 pillar 页](/zh/wiki/astrology-terms)里那一组描述行星夹角的概念，最好当成这组关系中的一员来读，而不是一个孤立的标签。它和三分相、四分相一样，都是相位家族里的一种角度。
...
1. **它 vs 三分相。** 三分相是 120 度，两颗行星毫不费力地合作；它则要你先推一把。要换来[三分相深度解析](/zh/wiki/trine-in-astrology)那种不费劲的顺流，你就牺牲掉发展它的紧迫感，天赋因此可能一直闲置；要换来这个角度的成长，你就牺牲掉那份舒服，得自己迈出第一步。
...
- [主要相位总览说明](/zh/wiki/astrology-terms) —— 想看这个角度以外、星盘上完整的一组角度，从这里读起
