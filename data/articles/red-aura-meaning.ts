...
export const redAuraMeaningEn: WikiArticle = {
  ...
  image_alt:
    "red aura energy field contrasting vibrant clear red with muddy dark red, root chakra",
...
### A weather report, not a verdict
...
### Red is not "lower" on a hierarchy
