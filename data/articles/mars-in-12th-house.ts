// Article: What Mars in 12th House Really Says About Hidden Drive and Anger
...
export const marsIn12thHouseEn: WikiArticle = {
  ...
  content: `# What Mars in 12th House Really Says About Hidden Drive and Anger

## What is Mars in the 12th house?

Mars in 12th house describes a placement where the planet of drive, will, and anger sits in the chart's most private, behind-the-scenes sector, the part of the chart mapped in this [overview of the twelfth house in astrology](/en/wiki/12th-house-astrology). In plain terms, it points to **a fighting energy that operates underground rather than out in the open**. The drive is not missing; it works indirectly, often surfacing in dreams, fatigue, or sudden bursts that seem to come from nowhere. This is not a clinical interpretation or mental health advice.
...
export const marsIn12thHouseZh: WikiArticle = {
  ...
  content: `# 火星在12宫：那股被压在水面下的劲，到底去了哪里

## Mars in the 12th house 是什么？

Mars in the 12th house（火星在12宫）指的是出生星盘里，掌管行动、欲望与愤怒的火星，落在最幽微、最不外显的第十二宫，是 [内在伤口疗愈 pillar 总览页](/zh/wiki/healing-your-inner-wound) 里很典型的一种隐藏动力。换句话说，**火星在12宫是一股被压在水面下的行动力**。这股劲不是消失了，而是改了路线：它常常在你自己都没察觉的地方运作，迟一步才以情绪、梦境或突然的冲动浮上来。本文不构成临床诊断或心理咨询建议。这里只想给你一套观察自己的语言。
...
- [第十二宫总览与象征意义指南](/zh/wiki/12th-house-astrology) — 把火星放回整个第十二宫的语境，理解这股驱力为什么走幕后。
