// Article: Why Punarvasu Reads Setbacks as the Return of Light, Not the End
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const punarvasuNakshatraEn: WikiArticle = {
  slug: "punarvasu-nakshatra",
  image: "/images/blog/punarvasu-nakshatra.jpg",
  image_alt: "Ancient road arcing back toward a golden horizon under deep indigo sky, Jupiter rising as the return of light after darkness",
  title: "Why Punarvasu Reads Setbacks as the Return of Light, Not the End",
  description: "Punarvasu is the 7th lunar mansion of Vedic astrology, ruled by Jupiter and governed by the goddess Aditi, whose core theme is return, renewal",
  ...
  content: `# Why Punarvasu Reads Setbacks as the Return of Light, Not the End
...
2. **Punarvasu vs. Cancer-Moon nurture.** Both touch Cancer, so they look adjacent, but the engine differs. Cancer-Moon energy soothes and protects; Jupiter-ruled Punarvasu expands and re-frames. Leaning on the station as emotional comfort gets you reassurance, but you lose its sharper offer — a perspective that treats the setback itself as instructive rather than merely something to be survived.

3. **The Gemini and Cancer halves.** Because the station crosses from Gemini into Cancer, its restoration runs in two registers. The Gemini portion contributes intellectual agility — the recovery happens partly through reframing, curiosity, and new ideas. The Cancer portion adds emotional depth, anchoring the recovery in felt experience rather than abstraction. Read together, the dual placement explains why Punarvasu natives tend to be resilient rather than merely reactive: they rebuild with both the mind and the heart engaged.


![Three-column comparison of Punarvasu renewal, simple fresh start, and Cancer-Moon nurture](/images/blog/punarvasu-nakshatra-i0-en.svg)
...
![Five-step sequence for reading Punarvasu placement in a Vedic natal chart](/images/blog/punarvasu-nakshatra-i1-en.svg)
...
| Property | How It Works | Where It Sits | How to Observe |
|---|---|---|---|
| Ruling planet | Jupiter's expansion turns recovery into wider wisdom, not mere repair | Lord of the station across both halves | Notice where setbacks return as perspective rather than scar tissue |
| Presiding deity | Aditi, the boundless sky, grants inexhaustible renewal potential | Cosmic-mother principle behind the whole station | Watch where a "second chance" arrives even after accumulated loss |
| Gemini portion | Intellectual agility drives recovery through reframing and curiosity | 20° to 30° Gemini | Recovery shows up as new ideas and adaptable thinking |
| Cancer portion | Emotional depth anchors the restoration in felt experience | 0° to 3°20' Cancer | Recovery shows up as renewed feeling and inner steadiness |
...
- [Vimshottari dasha system explainer](/en/wiki/mahadasha) — how Jupiter's periods unfold once you know your Moon's natal station
...
export const punarvasuNakshatraZh: WikiArticle = {
  ...
  content: `# 普纳瓦苏为何把挫折读成光的归来，而不是终点

## 普纳瓦苏星宿是什么?

普纳瓦苏（Punarvasu）是**吠陀占星中的第 7 个月宿，由木星主管、以天空之母神 Aditi 为守护神，其核心母题是回归、更新，以及带着比从前更多的智慧重新出发的能力**。理解这个月宿，绕不开它横跨双子座末与巨蟹座初的特殊位置，想把它放进 *27 月宿总览指南* 这张大图里看，才不会把它单读成一句"东山再起"。
...
- *Vimshottari 大运体系详解* —— 一旦你知道月亮的本命月宿，木星的周期会如何展开
