// Article: How to Pick Crystals for Each Chakra by Energy, Not Just Color
...
Chakra crystals are stones paired with the seven energy centers of the body, where the idea of crystals for each chakra means **matching a stone to a center by its energy state, not its color alone**. Each center sits along the spine and gets one or two go-to stones, building on the framework Anodea Judith established, and the pairing sits inside the larger [pillar page on the full chakra system](/en/wiki/chakra-system-overview) that maps how the seven centers relate.
...
| Energy Center | Common Crystals | How It Works | How to Observe |
| --- | --- | --- | --- |
| Root | Red jasper, hematite | Lends a steadying, grounded quality | Notice restlessness or feeling unsafe after stress |
| Sacral | Carnelian, orange calcite | Supports creative and emotional flow | Watch for flat or stuck feelings around pleasure |
| Solar plexus | Citrine, tiger's eye | Reinforces drive and steady confidence | Spot hesitation or pushiness in decisions |
| Heart | Rose quartz, green aventurine | Eases openness and self-kindness | See whether you give too much or close off |
| Throat | Aquamarine, blue lace agate | Encourages clear, honest expression | Catch the urge to go silent or over-explain |
