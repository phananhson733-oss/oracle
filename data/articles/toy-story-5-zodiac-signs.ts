// Article: What the Toy Story 5 Zodiac Signs Say About Woody, Buzz, and the New Cast
...
export const toyStory5ZodiacSignsEn: WikiArticle = {
  ...
  content: `# What the Toy Story 5 Zodiac Signs Say About Woody, Buzz, and the New Cast
...
| Character | How the Archetype Works | Energy Center (Playful) | How to Observe It On Screen |
|---|---|---|---|
| Woody (Tom Hanks) | Loyalty and duty read as a steady, dependable archetype | A grounded, earth-leaning steadiness | Watch how he keeps the group together and puts the kid first |
| Buzz Lightyear (Tim Allen) | Idealism and courage read as a bold, fire-leaning archetype | A confident, forward-driving spark | Notice his readiness to act and his belief in a bigger mission |
| Jessie (Joan Cusack) | Warmth and high energy read as an expressive, lively archetype | An outgoing, enthusiastic register | Spot her quick emotion and the way she rallies the others |
| Lily the tablet (Greta Lee) | A controlling, attention-pulling antagonist archetype | A magnetic, intense pull | See how she draws Bonnie's focus away from the toys |
...
Pick the Toy Story 5 character whose personality feels closest to yours, then generate your own chart to see how your real Sun sign compares to the archetype you chose. [Generate your free birth chart](/en/birth-chart-calculator) and you will get a clear view of your actual Sun sign laid out from your birth date. The contrast between a playful character pick and your documented chart is a small, honest reminder that the fun of archetypes and the facts of a real chart are two different things worth keeping apart.
...
export const toyStory5ZodiacSignsZh: WikiArticle = {
  ...
  content: `# 玩具总动员5星座：胡迪、巴斯与新角色背后的趣味星座解读
