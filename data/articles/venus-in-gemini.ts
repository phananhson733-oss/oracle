// Article: What Venus in Gemini Reveals About How You Love and Connect
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const venusInGeminiEn: WikiArticle = {
  slug: "venus-in-gemini",
  image: "/images/blog/venus-in-gemini.jpg",
  image_alt: "Two intertwining arcs of golden air light merging in a deep indigo cosmos, evoking Venus in Gemini love through curiosity and exchange",
  title: "What Venus in Gemini Reveals About How You Love and Connect",
  description: "Venus in Gemini places the planet of love, beauty, and value in a mutable air sign ruled by Mercury.",
  ...
  keywords: [
    ...
    "venus in gemini birth chart",
    "venus in gemini zodiac",
    "venus in gemini interpretation"
  ],
  content: `# What Venus in Gemini Reveals About How You Love and Connect
...
![Comparison of Venus in Gemini and Venus in Libra love styles showing key differences in approach](/images/blog/venus-in-gemini-i0-en.svg)
...
![Six observable signals of Venus in Gemini placement arranged as a visual checklist](/images/blog/venus-in-gemini-i1-en.svg)
...
|----------|--------------|---------------|----------------|
| Communication style | Love flows through talk, wit, and shared ideas | Air element, ruled by Mercury | Long threads and banter matter more than grand gestures |
| Attraction trigger | Sparked by novelty, range, and mental play | Mutable modality | Lights up around people who know or do many things |
| Core value | Prizes freedom, equality, and open dialogue | Third-house themes of exchange | Protects room to think aloud and change its mind |
| Common shadow | Restlessness can read as detachment | Mercury's quick tempo | Interest fades when routine outweighs stimulation |
