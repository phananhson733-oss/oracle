// Article: What Is My Life Purpose, Read Through Your Birth Chart
// Generated from flow-mvp _staging/ by tools/scripts/gg-md-to-oracle-ts.mjs.
import type { WikiArticle } from "../../types";

export const whatIsMyLifePurposeEn: WikiArticle = {
  slug: "what-is-my-life-purpose",
  image: "/images/blog/what-is-my-life-purpose.jpg",
  image_alt: "Birth chart life purpose reading — North Node, Sun, and Midheaven as gold star signatures pointing toward a glowing direction of growth",
  title: "What Is My Life Purpose, Read Through Your Birth Chart",
  description: "\"What is my life purpose\" is the question astrology approaches not as a fixed destiny but as a direction of growth, read through a few core natal signatures—your North Node, Sun sign, and Midheaven—treated together as symbols of where your life tends to stretch and mature.",
  ...
  keywords: [
    ...
    "what is my life purpose meaning",
    "what is my life purpose astrology",
    "what is my life purpose birth chart",
    "what is my life purpose zodiac",
    "what is my life purpose interpretation"
  ],
  content: `# What Is My Life Purpose, Read Through Your Birth Chart
...
![Comparison of North Node as growth edge versus South Node as inherited effortless strength in a birth chart life purpose reading](/images/blog/what-is-my-life-purpose-i0-en.svg)
...
![Five-step sequence for reading life purpose through North Node, Sun sign, Midheaven, South Node, and overlapping chart signatures](/images/blog/what-is-my-life-purpose-i1-en.svg)
...
| Signature | How It Works | Energy Center | How to Observe |
| --- | --- | --- | --- |
| North Node | Marks the growth edge you're stretching toward | Its natal house and sign | Tasks that feel awkward yet quietly rewarding |
| Sun sign | Shows the core identity you express most fully | Its natal house | Where you feel most yourself when open and unguarded |
| Midheaven | Points to public role and contribution | The 10th-house cusp | The reputation you're steadily building over time |
| South Node | Holds inherited, effortless strengths | The point opposite the North Node | Skills that come easily but no longer stretch you |
