...
The Chakra System（脉轮系统）是一套把人体能量分成七个能量中心的框架，每个中心对应一组生活主题。这些中心又叫脉轮（chakra，西方瑜伽与灵性传统中的能量中心概念），从安全感、表达到亲密关系，各管一摊。想先看清七个中心各自负责什么，可以参考 [脉轮系统总览 pillar 页](/en/wiki/chakra-system-overview)。所谓脉轮测验，就是用一组问题去感受这些中心此刻偏强还是偏弱。简单说，**脉轮测试是对你当下能量主题的一次快照**。
...
- [气场颜色总览 pillar 页](/en/wiki/aura-colors-pillar) —— 想从颜色这条线索理解能量，可以和脉轮结果对照着看。
