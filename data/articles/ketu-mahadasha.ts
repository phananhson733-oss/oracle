// Article: What Ketu Mahadasha Really Asks of You Over Seven Years
...
| --- | --- | --- | --- |
| Duration | Runs seven fixed years inside the Vimshottari sequence | Begins by dasha order, not by age | Track the start date from your Vedic chart's dasha table |
| Core theme | Subtracts over-identification so detachment can surface | Ketu's natal house and sign | Notice which life area quietly loosens its grip |
| Inner pull | Turns attention from outer gain to inner search | The house Ketu occupies natally | Watch for rising interest in solitude or study |
| Emotional tone | Loosens attachments so endings feel clean | Sign and house of natal Ketu | See whether closures arrive with less drama than expected |
...
- [explainer on the difference between Vedic and Western astrology](/en/wiki/vedic-vs-western-astrology) — clarifies why a dasha period has no direct equivalent in a Western chart.
- [Dasha (astrology) (Wikipedia)](https://en.wikipedia.org/wiki/Dasha_(astrology)) — background on the timing framework behind the seven-year cycle.
...
export const ketuMahadashaZh: WikiArticle = {
  ...
  content: `# 读懂计都大运这七年，是出离不是失去

## Ketu Mahadasha 是什么？

Ketu Mahadasha（计都大运）是吠陀占星 Vimshottari 大运体系里，由南交点"计都"主管的一段七年人生周期。要看懂它，得先了解 [大运体系总览 pillar 页](/zh/wiki/mahadasha) 怎么把一生切成一段段行星轮值的时期——每颗星各管一段，南交点主管的那一段，就是这里要谈的主题。古典文献《Brihat Parashara Hora Shastra》（相传由圣者 Parashara 传下）把计都描述成一颗"影子星"，它对应的是出离、收尾和灵性方向的转回，而不是外在的成败得失。也正因如此，传统并不把这七年读成"注定要失去"，更准确地说，它是**一段向内收束、把事情告一段落的周期**。
...
- [吠陀占星与西方占星的差异说明](/zh/wiki/vedic-vs-western-astrology) — 这套大运周期属于吠陀占星，先分清它和西方占星的底层假设，才不会把南交点的读法套错框架。
