// Article: Why the 5th House Asks You to Risk Being Seen
...
export const fifthHouseEn: WikiArticle = {
  ...
  content: `# Why the 5th House Asks You to Risk Being Seen
...
In the lineage of psychological astrology that Howard Sasportas helped shape, this house is the stage where your inner self steps forward — not to win approval, but for the pleasure of being. It sits within the wider system mapped in the [pillar guide to the twelve astrological houses](/en/wiki/astrology-houses), where each house describes a different arena of life. Reading it well means looking past romance and hobbies to the quieter question of whether you let yourself be fully seen, which is what separates a shallow reading from a genuinely useful one.
...
1. **This house versus the eleventh.** The fifth works in a deeply personal register, pushing you to express your individual spark for its own sake, with no audience required. The opposite [spoke page on the 11th house](/en/wiki/11th-house) works through groups, friendships, and shared ideals, where the self is one voice among many. To get the undiluted joy of self-expression the fifth offers, you sacrifice the safety of blending into a collective; the eleventh hands you belonging in return, but quietly asks you to soften the very thing that makes you singular.
...
| --- | --- | --- | --- |
| Creative expression | Channels the urge to make something unmistakably yours | Sun / Leo (fire) | You lose track of time making, performing, or playing |
| Romance and pleasure | Draws you toward what delights you, for its own sake | Sun / Leo (fire) | You pursue flirtation or hobbies with no goal but joy |
| Children and play | Carries a playful, generative impulse, literal or creative | Sun / Leo (fire) | You light up around kids, games, or open-ended making |
| The risk of being seen | Asks you to show the real self and tolerate the response | Sun / Leo (fire) | You feel exposed when sharing work or being admired |
...
- [guide to planets in the houses](/en/wiki/astrology-houses) — how a planet's placement shapes where and how your energy expresses itself
...
export const fifthHouseZh: WikiArticle = {
  ...
  content: `# 第五宫代表什么，远不止恋爱与玩乐

## The 5th House 是什么？

第五宫（the 5th house）是星盘里掌管创造、恋爱、游戏与自我表达的宫位，也是 [占星十二宫总览 pillar 页](/zh/wiki/astrology-houses) 当中很容易被误读的一个。要回答第五宫代表什么，核心的一句是：它是**你纯粹做自己的舞台**。你在这里做事，不为完成任务、也不为取悦谁，只因为那件事让你觉得「这就是我」。心理占星传统里，像 Howard Sasportas 这样的作者就把它描述成「内在太阳想要发光」的领域，它也因此常和狮子座、太阳的能量连在一起。
...
- *太阳与自我表达深度解析* — 第五宫的发光冲动和太阳的原型本就相通，想更懂「想被看见」可以从这里入手。
- *狮子座能量指南* — 这一宫天然带着狮子座的舞台感，了解狮子座能帮你看清这股表达欲。
