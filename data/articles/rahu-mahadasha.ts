// Article: What Rahu Mahadasha Really Brings Over Its 18-Year Span
...
|---|---|---|---|
| Duration | Runs about 18 years as one continuous Vimshottari period | Sits within the standard nine-planet dasha sequence | Note the start year from your dasha chart |
| Core theme | Amplifies desire and the pull toward the unfamiliar | Colored by the house and sign Rahu occupies in the birth chart | Watch where ambition and restlessness concentrate |
...
- [Dasha (astrology) (Wikipedia)](https://en.wikipedia.org/wiki/Dasha_(astrology)) — for the broader timing framework behind the 18-year period.
- [Lunar node (Wikipedia)](https://en.wikipedia.org/wiki/Lunar_node) — for what the north node actually is in observational terms.
...
export const rahuMahadashaZh: WikiArticle = {
  ...
  content: `# 读懂罗睺大运，不必把这十八年当成劫数

## Rahu Mahadasha 是什么？

罗睺大运（Rahu Mahadasha）是吠陀占星 Vimshottari 行星周期体系里，由北交点罗睺（月亮升交点）主管的一段时间，通常被读作**北交点罗睺主管的十八年生命周期**；这套大运划分系统记载于经典《Brihat Parashara Hora Shastra》。要先弄清更上位的 [大运周期 mahadasha 总览页](/zh/wiki/mahadasha)，才好理解罗睺这一段在整套周期里的位置。它本身不是吉凶判定，而是一段被传统描述为"放大"的窗口期。
...
罗睺大运最该拿来对照的，是它的对宫搭档——南交点计都主管的那段周期。罗睺向外、向新、向"想要更多"，运作方式是把欲望和野心调高，推着人去抓尚未拥有的东西；[计都大运周期说明](/zh/wiki/ketu-mahadasha)则向内、向放下、向"够了就好"。这里就藏着取舍：选择跟着罗睺向外扩张，你换来的是机会和体验的拓宽，代价是更容易心神不宁、难以满足；而计都那一极给你的安定，是以削弱进取动力为代价的。
...
- [吠陀占星与西方占星差异说明](/zh/wiki/vedic-vs-western-astrology)——罗睺在两套体系里的用法很不一样，这篇梳理了它们看待行星与周期的根本分歧。
