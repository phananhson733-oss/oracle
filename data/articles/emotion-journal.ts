// Article: Emotion Journal Habits That Name Feelings Instead of Just Logging Them
...
export const emotionJournalEn: WikiArticle = {
  ...
  content: `# Emotion Journal Habits That Name Feelings Instead of Just Logging Them
...
| Property | How It Works | Naming Focus | How to Observe |
|---|---|---|---|
| Quick mood log | Rates or tags a state in seconds | Minimal — a single word or score | Fast trend lines, but feelings stay diffuse |
| Two-part entry | Separates what happened from how it felt | High — names the feeling apart from the event | Deeper integration; the feeling gets its own precise label |
| Free-form venting | Writes the feeling out at length | Low — expression without a target word | Release in the moment, but the same loop often repeats |
| Pattern review | Reads back entries to spot recurrences | Cumulative — surfaces repeated labels | A self-regulation diary that reveals triggers over weeks |
...
export const emotionJournalZh: WikiArticle = {
  slug: "emotion-journal",
  image: "/images/blog/emotion-journal.jpg",
  image_alt: "暮色地平线上星云凝聚成清晰星座的风景，象征在情绪日记中精准命名感受的过程",
  title: "情绪日记真正有用的地方，是给感受起一个准确的名字",
  description: "情绪记录练习指的是情绪日记是一边写一边给感受起准确名字的练习，而不是把心情逐条登记的清单。这样写的本子，要求你把一团模糊的内在状态翻成语言——写\"我觉得被晾在一边\"，而不是只写\"今天很糟\"，正是这一小步翻译，把反思和流水账分开。",
  authorId: "elena-vane",
  date: "2026-06-13",
  schema: "Article",
  lang: "zh",
  ...
  content: `# 情绪日记真正有用的地方，是给感受起一个准确的名字

## 情绪记录练习是什么？

情绪记录练习指的是**情绪日记是一边写一边给感受起准确名字的练习，而不是把心情逐条登记的清单**。这样写的本子，要求你把一团模糊的内在状态翻成语言——写"我觉得被晾在一边"，而不是只写"今天很糟"，正是这一小步翻译，把反思和流水账分开。想知道这个起名习惯落在更大的反思练习里的什么位置，可以读*自我反思日记提示词支柱页*这一类内容，它给情绪记录练习提供了更宽的背景。
...
![命名式情绪日记、心情记录和自由抒发在深度、速度与模式识别上的对比](/images/blog/emotion-journal-i0-zh.svg)
...
![情绪日记中情感标记奏效的四个信号：词汇精确化、语境附着、情绪松动、重复浮现](/images/blog/emotion-journal-i1-zh.svg)
