// Article: Mahadasha Explained: Reading Vedic Planetary Periods as Seasons, Not Sentences
...
| --- | --- | --- | --- | --- |
| Ketu | 7 | Detachment, endings, inner search | Spirituality, loss, letting go | Read only as bad luck rather than release |
| Venus | 20 | Relationship, comfort, artistry | Love, beauty, wealth, pleasure | Assuming all 20 years feel easy and indulgent |
| Sun | 6 | Authority, visibility, self-definition | Status, father, leadership, health | Treated as guaranteed fame rather than a test of ego |
| Moon | 10 | Emotion, nurture, the public | Mind, mother, home, audiences | Mistaking emotional sensitivity for instability |
| Mars | 7 | Drive, courage, conflict | Energy, siblings, property, disputes | Read as pure aggression instead of focused effort |
| Rahu | 18 | Ambition, hunger, the unconventional | Worldly gain, foreign matters, obsession | Cast as a curse rather than a period of intense growth |
| Jupiter | 16 | Wisdom, expansion, fortune | Knowledge, children, faith, mentors | Expecting easy luck with no responsibility attached |
| Saturn | 19 | Discipline, delay, maturity | Work, endurance, time, limitation | Equated with punishment instead of slow building |
| Mercury | 17 | Intellect, exchange, skill | Communication, business, learning | Reduced to mere cleverness without depth |
...
- [explainer on the Rahu planetary period](/en/wiki/rahu-mahadasha) for the 18-year node period readers ask about most
- [guide to the Ketu planetary period](/en/wiki/ketu-mahadasha) for the 7-year node period and its themes of release
...
它出自 [吠陀占星核心概念总览](/zh/wiki/vedic-vs-western-astrology) 中的 Vimshottari（维姆肖塔里）大运体系，这套算法在古典文献《Brihat Parashara Hora Shastra》（帕拉萨拉占星大典）中有系统记载。九段大运分别以主管它的行星命名——计都大运、金星大运、太阳大运、月亮大运、火星大运、罗睺大运、木星大运、土星大运、水星大运。每个人出生时，月亮落在哪一个 nakshatra（月宿，吠陀占星对星空的二十七段划分）决定了你从哪一段开始、还剩多少，之后就一段接一段往下走。所以行星大运不是某一颗行星的判词，而是一张覆盖一生的时间地图。

## 为什么先理解整个家族

九段行星大运同属一个家族，是首尾相接的周期，而不是九个孤立的标签。很多人第一次听到这个词，是在一份吠陀星盘报告里，或者被占星师一句「你正走在罗睺大运里，最近要小心」吓到。问题在于，这句话把一整套大运系统压缩成了一句判决，让人误以为某一段时期就等于某种固定的好坏。但只看单独一段，就像只读一本书的某一章却不知道前后情节——你会把这一章的张力当成整个故事的结局。
...
先看懂整套系统，还能避免一个常见的张冠李戴：行星大运是吠陀占星独有的择时工具，西方占星里并没有这一套，西方看时间更多用行运（transit）和推运。如果你之前接触的是西方星座那一套，可以先了解 [吠陀占星与西方占星的差异对照](/zh/wiki/vedic-vs-western-astrology)，再回头看大运，会更清楚它为什么存在、解决的是什么问题。把九段看成一个整体，你才不会因为听到「罗睺」「土星」这种被传得很可怕的名字就先自我惊吓。
...
**计都大运（7 年）** — 计都是月亮的南交点，这段时期常被描述成向内收的阶段：兴趣从外在成就转向反思、独处与灵性议题，旧的执着容易松动。常见误读是把它当成「失去年」，仿佛注定要被夺走什么；更贴切的读法是，它松手的往往是你本就抓得太紧、该放的东西。层次详见 [计都大运深度解析](/zh/wiki/ketu-mahadasha)。

**金星大运（20 年）** — 九段里最长的一段，主题落在关系、美感、艺术、舒适与物质资源上，常对应感情与财务比较活跃的时期。常见误读是以为这二十年必然甜蜜顺遂；它放大的其实是「价值与连结」，既可能带来享受，也可能让人卡在过度沉溺里。完整脉络见 [金星大运深度解析](/zh/wiki/venus-mahadasha)。
...
**罗睺大运（18 年）** — 罗睺是月亮的北交点，也是被传得最「可怕」的一段，主题是欲望、扩张、世俗野心与陌生新奇的领域。常见误读是把这十八年当成注定的混乱与灾难；更准确地说，它放大的是「想要更多」的冲动，能推人冲向成就，也容易让人迷失在不知足里。问的人最多，细节见 [罗睺大运深度解析](/zh/wiki/rahu-mahadasha)。

**木星大运（16 年）** — 主题是成长、学习、信念、师长与扩展，常被视为相对滋养的一段。常见误读是以为天上一定掉馅饼；它给的是机会和视野，但要不要接、能不能消化，仍看你自己。

**土星大运（19 年）** — 仅次于金星的长段，主题是责任、纪律、磨炼与长期建设，节奏偏慢、要求偏高。常见误读是读成「只有苦没有甜」；它确实严格，但回报往往来自踏实的累积，而不是侥幸。长期逻辑见 [土星大运深度解析](/zh/wiki/saturn-mahadasha)。
...
2. **遇到分歧硬选一个当标准答案。** 不同老师对同一段大运的强调各有侧重，更稳妥的是看哪种说法贴合你的实际处境，而不是把某一家奉为定论。
...
- [罗睺大运深度解析](/zh/wiki/rahu-mahadasha) — 最常被问起的十八年节点周期
- [土星大运深度解析](/zh/wiki/saturn-mahadasha) — 十九年的责任与长期建设之路
- [金星大运深度解析](/zh/wiki/venus-mahadasha) — 二十年的关系与资源主题
- [计都大运深度解析](/zh/wiki/ketu-mahadasha) — 七年的收束与内省周期
- [吠陀占星核心概念总览](/zh/wiki/vedic-vs-western-astrology) — 大运所属的更大体系
- [吠陀占星与西方占星的差异对照](/zh/wiki/vedic-vs-western-astrology) — 两套体系的择时方式对照
