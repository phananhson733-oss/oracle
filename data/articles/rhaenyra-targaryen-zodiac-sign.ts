// Article: Why the Rhaenyra Targaryen Zodiac Sign Reads as Scorpio, Not Fire
...
export const rhaenyraTargaryenZodiacSignEn: WikiArticle = {
  ...
  content: `# Why the Rhaenyra Targaryen Zodiac Sign Reads as Scorpio, Not Fire
...
The same behavior-first method drives other character reads, like our [toy story 5 zodiac signs](/en/wiki/toy-story-5-zodiac-signs) breakdown, which translates a sign into observable behavior instead of vague vibes.
...
- [House of the Dragon (Wikipedia)](https://en.wikipedia.org/wiki/House_of_the_Dragon)
`,
};
...
- 粉丝与占星写手对她算哪个星座并无共识；本文主张的是，天蝎在行为层面的证据最为有力

这种"行为优先"的方法，也支撑着我们对其他角色的解读，比如 [玩具总动员5 角色星座解读](/zh/wiki/toy-story-5-zodiac-signs)，它把一个星座翻译成可观察的举动，而不是模糊的氛围感。
...
这种纠正并不只是学术问题。一旦你为这种模式贴对了标签，就可以有意识地借用它：那种等待真正缺口出现的耐心，那种拒绝重蹈覆辙的记忆，那种遇压则更坚硬而非更张扬的意志。这些都是可习得的习惯，而它们每一次读起来都像天蝎。关于这份解读所倚靠的固定水象深度，可参看 [北交点在天蝎座](/zh/wiki/north-node-in-scorpio)。

## 雷妮拉的星座与相近概念：运作方式 + 取舍

粉丝与占星写作者其实并未就雷妮拉的星座达成一致，各种说法都有，有几个站点甚至把天蝎安在密丽珊（Mysaria）而非她身上。但只要把火象的猜测放到一边，最能说明问题的对决其实是天蝎对金牛：两个远看十分相似的固定星座。它们都固执，都能熬，都不肯松手。区别在于各自不肯松开的究竟是什么，而正是这一点决定了解读走向。
...
没有。不同作者各执一词，天蝎有时还被安到密丽珊身上。因为没有正史生日，这些都无法被证明——本文主张的是，天蝎的固定水象侧写最贴合她的行为。
...
- [珀耳塞福涅女神原型](/zh/wiki/persephone-goddess)——另一个借原型而非生日来解读的神话人物。
- [北交点在金牛座](/zh/wiki/north-node-in-taurus)——固定星座之争里的金牛一侧，可作对照。
- [北交点与南交点](/zh/wiki/north-node-vs-south-node)——业力的南北交点轴线，与她天蝎—金牛式的固定之争互为映照。
- [雷妮拉·坦格利安（维基百科）](https://zh.wikipedia.org/wiki/%E9%9B%B7%E5%A6%AE%E6%8B%89%C2%B7%E5%9D%A6%E6%A0%BC%E5%88%A9%E5%AE%89)——关于她全剧弧线的背景。
...
- [天蝎座（占星）（维基百科）](https://zh.wikipedia.org/wiki/%E5%A4%A9%E8%9D%8E%E5%BA%A7%EF%BC%88%E5%8D%A0%E6%98%9F%EF%BC%89)
- [龙之家族（维基百科）](https://zh.wikipedia.org/wiki/%E9%BE%99%E4%B9%8B%E5%AE%B6%E6%97%8F)
`,
};
