// Article: Why Your Black Moon Lilith Placement Keeps Changing (True vs. Mean vs. Asteroid Lilith Explained)
...
export const blackMoonLilithEn: WikiArticle = {
  ...
  content: `# Why Your Black Moon Lilith Placement Keeps Changing (True vs. Mean vs. Asteroid Lilith Explained)
...
| Property | How It Works | Sign Stability | How to Observe |
|---|---|---|---|
| Mean Lilith (apogee average) | Smoothed average of the Moon's apogee path | ~40° per year, slow and stable | Check whether two apps agree on sign — if they do, likely using mean |
| True Lilith (oscillating apogee) | Real-time apogee geometry, tracks actual oscillation | Can shift sign within days near oscillation peaks | Recalculate the same birth data one week earlier or later; if sign shifts, you are reading true |
| Asteroid Lilith (1181) | Physical rock in the main asteroid belt | Standard elliptical orbit, consistent | Find sign in an asteroid ephemeris; will differ from both apogee versions |
| White Moon Selena | Lunar perigee, counter-pole to the apogee | Moves at a comparable rate to mean Lilith | Read alongside the apogee versions as the integrative counter-point in the orbital pair |
...
- [guide to the lunar nodes and nine-year nodal cycle](/en/wiki/north-node-vs-south-node) — the nodal cycle is frequently confused with Lilith's orbital period; this page clarifies how the two timelines differ
- *White Moon Selena explainer* — the counter-pole to the apogee Lilith, tracking the Moon's perigee position in the chart
- [Lilith in the signs and houses guide](/en/wiki/astrology-houses) — sign-by-sign and house-by-house breakdown of how the suppression pattern tends to show up in different life arenas

## Take Action

[Generate your free birth chart](https://astrologywiki.com/en/wiki/how-to-read-birth-chart) to find your exact black moon lilith placement — and check which calculation method your chart is using. Knowing whether you are working with mean or true tells you which interpretive sources apply and where the contradictions in past readings actually came from.
