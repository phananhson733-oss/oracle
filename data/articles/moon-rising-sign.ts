// Article: Moon and Rising Sign: How Your Inner Tides and Outer Mask Work Together
...
export const moonRisingSignEn: WikiArticle = {
  ...
  content: `# Moon and Rising Sign: How Your Inner Tides and Outer Mask Work Together
...
| Placement | What It Describes | Inner or Outer | How to Read It |
| --- | --- | --- | --- |
| Moon sign | Emotional needs, instincts, inner security | Inner self | What soothes or unsettles you before thought |
...
export const moonRisingSignZh: WikiArticle = {
  ...
  content: `# 月亮主导内在、上升塑造初见，三大星的这两颗如何配合成一个完整的你

## 月亮与上升是什么？

很多人把**月亮上升星座说成一个星座，其实月亮与上升是星盘里两个不同的点：月亮代表内在的情绪自我，上升（也叫上升星座、命宫）代表外在面貌与别人初见你的第一印象**。大家查月亮上升星座时，常期待找到一个单一答案，可这两者是三大星里相互独立的成员，把它们放在一起读，才能解释为什么一个人内在感受是一种样子、被人初见时又读成另一种样子。月亮回答的是"我私下是怎样的"，上升回答的是"我先被看成怎样的"，两个问题落在星盘的不同位置上。想看清它们怎么与太阳一起组成整体，*太阳月亮上升三大星支柱页*这一类内容把整组三大星放在同一处来讲。
...
大多数"月亮上升星座"的内容会把这一对当成一个标签，然后就停在那里。读者正是在这里被带偏，因为把两个点压成一个，恰好遮住了让这组合变得有趣的那道缝隙。月亮与上升真正要练的功夫，是把内在和外在分开来看：月亮是私下的天气，是在思考之前就先冒出来的那种感受；上升则是别人走进来认识你的那道门。这样握住它们，月亮上升星座这一对就成了一张小地图，量的是"你怎么感受"与"你初看是什么样"之间的距离。换句话说，把两者读成一个标签，损失的不是信息量，而是那份能让你认出"原来内外可以不同步"的觉察。
...
值得一提的是，这道缝隙也会反过来照见你看待别人的方式。当你只盯着一个人的上升去判断他，往往会错过他月亮所守护的那些更安静的需求；反过来，只凭对方某次情绪流露就给他贴一个标签，又会忽略他外在那套自我保护的接口本就有它的道理。把月亮与上升当成两条同时存在的线索来读，比起在两者间二选一，更接近一个人真实的复杂样貌——你给别人留出的余地，也常常正是你希望别人给自己留出的那一份。
...
这也是诚实读占星的立足处。传统上把星盘当成一种象征与内在意义的语言、而非一句固定标签来读，就不会把月亮或上升读成一道判决。Liz Greene 把星盘当作象征与内在意义的语言来对待，Robert Hand 则把星位看成可供解读的模式、而非决定行为的剧本，照这样读，月亮上升星座这一对就成了一个反思的提示：去问，你的内在需求和你的外在呈现在哪里同向、又在哪里分岔。想更深入看清这幅图里对外的那一半，[上升星座是什么意思的指南](/zh/wiki/how-to-read-birth-chart)单独把上升讲得更透。
...
- *太阳月亮上升三大星支柱页* —— 把整组三大星放在一起讲的中枢
- [上升星座是什么意思的指南](/zh/wiki/how-to-read-birth-chart) —— 把上升作为外在面貌看得更近的一篇
- [上升星座如何对应到宫位与人生领域](/zh/wiki/how-to-read-birth-chart) —— 上升在哪里为星盘铺开生活领域的地图
- [占星宫位与人生领域支柱页](/zh/wiki/astrology-houses) —— 上升所通向的那个更大框架
