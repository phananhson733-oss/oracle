...
export const TRANSLATIONS = {
  en: {
    ...
    auth: {
      ...
      benefit_ask: "10 Ask questions per week",
    ...
    pricing: {
      ...
      credits_subtitle:
        "Prefer pay-as-you-go? One-time credits for Ask, synastry, and Synthetica when you run out of your free quota.",
      credits_suffix: "credits",
      compare_title: "Free vs Pro",
      col_feature: "Feature",
      col_free: "Free",
      col_pro: "Pro",
      compare_rows: [
        { feature: "Ask questions", free: "3 / week", pro: "10 / week" },
    ...
    saved: {
      ...
      subtitle: "Revisit the charts and readings you've saved.",
      empty: "No saved readings yet. Save a reading to find it here.",
      loading: "Loading your saved readings…",
      error: "Couldn't load your saved readings. Please try again.",
      open: "Open",
      delete: "Delete",
      delete_confirm: "Delete this saved reading? This can't be undone.",
      deleting: "Deleting…",
      saved_on: "Saved",
      back: "Back to saved",
      not_found: "This reading was not found.",
      type_natal: "Natal chart",
      type_cycle: "Cycles",
      type_synastry: "Synastry",
      save: "Save",
      saving: "Saving…",
      save_done: "Saved",
    ...
    subscription: {
      ...
      free_benefit_4: "3 personality dimensions free",
      ...
      upgrade_reason_cbt_stats: "Unlock CBT statistics",
      upgrade_reason_synthetica: "Unlock Synthetica insights",
      upgrade_reason_ask: "Unlock Ask Q&A",
      ...
      cancel_lose_1: "Unlimited detail access (Me / Today / Us)",
      cancel_lose_2: "7 extra Ask questions per week",
      cancel_lose_3: "100 bonus credits per payment",
    ...
    paywall: {
      ...
      subscribe_value_hint: "Unlimited access to all features",
    ...
    landing: {
      ...
      trust_line: "Built on real astronomy, not fortune-telling.",
      // Birth chart section
      ...
      birth_chart_form_name_placeholder: "Your name (optional)",
      birth_chart_form_date_label: "Birth date",
      birth_chart_form_time_label: "Birth time",
      birth_chart_form_time_unknown: "Time unknown",
      birth_chart_form_city_placeholder: "City, Country (e.g., New York, USA)",
      birth_chart_form_date_required: "Please enter your birth date.",
      birth_chart_form_city_required:
        "Please enter the city where you were born.",
      birth_chart_submit: "Cast my chart",
      birth_chart_submitting: "Casting your chart...",
      birth_chart_error_location:
        "We couldn't find that place. Try a more specific name like 'Springfield, IL, USA'.",
      birth_chart_error_service:
        "Location service is temporarily unavailable. Please try again in a moment.",
      birth_chart_error_generic: "Something went wrong. Please try again.",
      birth_chart_result_sun: "Sun",
      birth_chart_result_moon: "Moon",
      birth_chart_result_rising: "Rising",
      birth_chart_result_intro:
        "Your chart, calculated. Below are the three placements that shape how you show up, how you feel, and how the world meets you.",
      birth_chart_save_cta: "Save my chart and unlock the full reading",
      ...
      today_personal_cta: "See your personal forecast →",
      today_loading: "Reading the sky...",
      ...
      tools_open: "Open",
      tools_open_action: "Open",
      // Wiki hub
      wiki_kicker: "The Wiki",
      wiki_title: "A living guide to the cosmos within you.",
      wiki_subtitle:
      ...
      wiki_today_label: "Today's transit",
      wiki_read_action: "Read",
      wiki_trending_label: "Trending",
      wiki_explore_cta: "Explore the Wiki →",
      wiki_loading: "Loading the cosmos…",
      wiki_resting: "The Wiki is resting — check back soon.",
      wiki_browse_cta: "Browse the Wiki →",
      // Synastry (own section, deeper than tool tile)
      synastry_kicker: "Synastry",
      synastry_title: "The geometry between two charts.",
      synastry_subtitle:
      ...
      synastry_diagram_caption: "where two charts overlap",
      synastry_cta: "Compare two charts →",
      // Ask Oracle (own section)
      ask_kicker: "Ask Oracle",
      ask_title: "The question you've been turning over.",
      ask_subtitle:
      ...
      ask_q_label: "Q",
      ask_a_label: "A",
      ask_example_q: "Why does my Saturn return feel so heavy?",
      ask_example_a:
      ...
      // Social proof / trust strip (current implementation)
      social_proof_kicker: "What we stand for",
      social_proof_heading_sr: "Trust and credibility",
      social_proof_accuracy_word: "Swiss",
      social_proof_accuracy_label: "Ephemeris precision",
      ...
      newsletter_title: "A letter, weekly, when the sky turns.",
      newsletter_subtitle:
        "One transit and one psychology lens for the week ahead. Unsubscribe in one click.",
      ...
      footer_link_birth: "Birth Chart",
      footer_link_transit: "Transit Chart",
      footer_link_synastry: "Synastry",
      footer_link_ask: "Ask Oracle",
      footer_link_wiki: "Wiki",
      footer_link_saturn: "Saturn Return",
      footer_link_today: "Today's Sky",
  ...
  zh: {
    ...
    auth: {
      ...
      benefit_ask: "每周 10 次 Ask 问答",
      benefit_synastry: "免费 3 次合盘 + 每周额外 1 次",
      benefit_bonus: "订阅成功发放 100 积分",
    ...
    pricing: {
      ...
      free_title: "免费",
      free_price: "¥0",
      free_desc: "核心星盘、百科与 CBT 日记，无需账户即可探索。",
      pro_title: "Pro",
      pro_badge: "最超值",
      monthly_label: "月付",
      yearly_label: "年付",
      ...
      credits_title: "积分包",
      credits_subtitle:
        "更喜欢按需付费？一次性积分用于 Ask、合盘与 Synthetica，免费额度用完时扣除。",
      credits_suffix: "积分",
      compare_title: "免费 vs Pro",
      col_feature: "功能",
      col_free: "免费",
      col_pro: "Pro",
      compare_rows: [
        { feature: "Ask 提问", free: "3 次/周", pro: "10 次/周" },
        { feature: "Synastry 合盘", free: "3 次（终身）", pro: "每周 +1 次" },
        { feature: "Synthetica", free: "3 次/天", pro: "10 次/天" },
        { feature: "查看详情", free: "2 次免费", pro: "无限制" },
        { feature: "心理维度", free: "前 3 个", pro: "全部解锁" },
        { feature: "月度 CBT 统计", free: "锁定", pro: "解锁" },
        { feature: "订阅奖励", free: "—", pro: "每次支付 +100 积分" },
      ],
    ...
    saved: {
      title: "已保存解读",
      subtitle: "回看你保存过的星盘与解读。",
      empty: "还没有保存的解读。保存一份后会出现在这里。",
      loading: "正在加载你保存的解读…",
      error: "加载失败，请稍后重试。",
      open: "打开",
      delete: "删除",
      delete_confirm: "删除这份保存的解读？此操作无法撤销。",
      deleting: "删除中…",
      saved_on: "保存于",
      back: "返回已保存",
      not_found: "未找到该解读。",
    ...
    subscription: {
      ...
      free_benefit_4: "3 个心理维度免费体验",
      free_benefit_5: "今日运势永久免费",
      free_benefit_6: "百科永久免费",
      free_benefit_7: "CBT 日记永久记录",
      buy_credits_cta: "购买积分",
      upgrade_reason_cbt_stats: "解锁 CBT 统计分析",
      upgrade_reason_synthetica: "解锁 Synthetica 洞察",
      upgrade_reason_ask: "解锁 Ask 问答",
      ...
      cancel_lose_1: "无限详情解读（自我 / 今日 / 合盘）",
      cancel_lose_2: "每周额外 7 次 Ask 提问",
      cancel_lose_3: "每次续费赠送 100 积分",
      cancel_keep: "保留订阅",
      cancel_processing: "处理中...",
      cancel_confirm: "确认取消",
      cancel_success_title: "订阅已取消",
      cancel_success_desc: "您的 Pro 权益将保留至到期日，届时不再自动续费。",
      cancel_got_it: "我知道了",
    },
    paywall: {
      ...
      subscribe_badge: "推荐",
      subscribe_value_hint: "订阅即享全部功能无限使用",
    ...
    landing: {
      ...
      birth_chart_form_name_placeholder: "你的名字（可选）",
      birth_chart_form_date_label: "出生日期",
      birth_chart_form_time_label: "出生时间",
      birth_chart_form_time_unknown: "时间未知",
      birth_chart_form_city_placeholder: "出生城市（如：北京，中国）",
      birth_chart_form_date_required: "请输入你的出生日期。",
      birth_chart_form_city_required: "请输入你出生的城市。",
      birth_chart_submit: "起盘",
      birth_chart_submitting: "正在起盘…",
      birth_chart_error_location:
        "未能识别这个地点。请尝试更具体的写法，例如「上海市，中国」。",
      birth_chart_error_service: "地点服务暂时不可用，请稍后再试。",
      birth_chart_error_generic: "出了点小问题，请稍后再试。",
      birth_chart_result_sun: "太阳",
      birth_chart_result_moon: "月亮",
      birth_chart_result_rising: "上升",
      birth_chart_result_intro:
        "你的本命盘已生成。下方三个核心位置，决定了你如何展现、如何感受，以及世界如何认识你。",
      birth_chart_save_cta: "保存我的星盘，解锁完整解读",
      // Today / cosmic weather
      today_kicker: "今日天象",
      today_title: "此刻行星的位置。",
      today_subtitle: "普世天象 — 不是个人化的运势预测。",
      today_cta: "查看你的专属运势",
      today_personal_cta: "查看你的个性化预测 →",
      today_loading: "正在读取天象…",
      ...
      tools_ask_desc: "问任何问题。几秒内得到一份有科学根基、懂心理的回答。",
      tools_open: "进入",
      tools_open_action: "进入",
      // Wiki hub
      wiki_kicker: "百科",
      wiki_title: "一本不断成长的内在宇宙指南。",
      wiki_subtitle:
        "一座持续更新的图书馆——行星、星座、宫位、相位与经典文献，与天象同步成长。",
      wiki_browse_all: "浏览全部 119 篇",
      wiki_cat_planets: "行星",
      wiki_cat_signs: "星座",
      wiki_cat_houses: "宫位",
      wiki_cat_aspects: "相位",
      wiki_today_label: "今日行运",
      wiki_read_action: "阅读",
      wiki_trending_label: "热门",
      wiki_explore_cta: "进入百科 →",
      wiki_loading: "正在召唤宇宙…",
      wiki_resting: "百科正在休息——稍后再来。",
      wiki_browse_cta: "前往百科 →",
      // Synastry section
      synastry_kicker: "合盘",
      synastry_title: "两张星盘之间的几何关系。",
      synastry_subtitle:
        "把两张星盘叠在一起，看见彼此交汇、摩擦与互相辨认的地方。这是关系占星，不是「灵魂伴侣」式的浪漫包装。",
      synastry_diagram_caption: "两张星盘重叠之处",
      synastry_cta: "比较两张星盘 →",
      // Ask section
      ask_kicker: "星象问答",
      ask_title: "那些你反复琢磨的问题。",
      ask_subtitle:
        "Ask Oracle 用平实的语言回答你关于占星与心理学的问题。没有术语，没有运势套话——只针对你真正想问的那件事，给出一次真诚的回应。",
      ask_q_label: "问",
      ask_a_label: "答",
      ask_example_q: "为什么我的土星回归感觉这么沉重？",
      ask_example_a:
        "土星落在你的第二宫，在回归的这几年常常以财务重组的形式出现——但更深的邀请，是让你在外界认可之外，重新搭建自我价值的根基。这份沉重不是惩罚，而是当没有人在看时，被认真追问「你到底重视什么」的那份分量。",
      ask_cta: "提出你的问题 →",
      // Social proof
      ...
      // Social proof / trust strip (current implementation)
      social_proof_kicker: "我们坚持什么",
      social_proof_heading_sr: "信任与可信度",
      social_proof_accuracy_word: "瑞士",
      social_proof_accuracy_label: "星历精度",
      ...
      footer_col_explore: "探索",
      footer_col_legal: "法务",
      footer_link_birth: "星盘解读",
      footer_link_transit: "行运预测",
      footer_link_synastry: "合盘分析",
      footer_link_ask: "Ask Oracle",
      footer_link_wiki: "百科",
      footer_link_saturn: "土星回归",
      footer_link_today: "今日星象",
