...
export const TRANSLATIONS = {
  en: {
    ...
    wiki: {
      ...
      featured_articles_subtitle: "In-depth guides for your cosmic journey",
      featured_articles_more: "View All",
    ...
    paywall: {
      ...
      credits_title: "Unlock with credits",
      credits_desc: "{scope} · Balance {balance}",
      credits_button: "Spend {points}",
      unlock_action: "Unlock",
      topup_title: "Buy credits",
      topup_desc: "Top up credits to unlock content",
      topup_button: "Choose pack",
      topup_soon: "Coming soon",
      ...
      points_label: "pts",
      quota_week: "per week",
      quota_forever: "lifetime",
      feature_names: {
        dimension: "Dimension",
        core_theme: "Core theme",
        daily_script: "Daily script",
        daily_transit: "Transit detail",
        synastry: "Synastry",
        synastry_detail: "Synastry detail",
  ...
  zh: {
    ...
    wiki: {
      ...
      tab_articles: "文章",
      articles_title: "占星文章",
      articles_subtitle: "深度指南与星象洞察",
      articles_kicker: "精选指南",
      articles_empty: "暂无文章",
      articles_back: "返回文章列表",
      article_author: "作者",
      article_date: "发布日期",
      article_read_more: "阅读全文",
      article_related: "相关文章",
      classics_kicker: "经典书架",
      classics_title: "与古人对话",
      ...
      featured_articles_title: "精选文章",
      featured_articles_subtitle: "深度占星指南与洞察",
      featured_articles_more: "查看全部",
      pillars_title: "四大支柱",
    ...
    subscription: {
      ...
      checkout_error: "无法启动订阅，请稍后再试。",
      portal_error: "暂时无法打开订阅详情。",
      benefits_title: "订阅包含",
      benefits: [
    ...
    paywall: {
      ...
      credits_title: "使用积分解锁",
      credits_desc: "{scope} · 余额 {balance}",
      credits_button: "消耗 {points}",
      unlock_action: "解锁",
      topup_title: "购买积分",
      topup_desc: "充值积分用于解锁内容",
      topup_button: "选择套餐",
      topup_soon: "即将上线",
