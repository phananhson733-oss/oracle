      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className={sectionClass}>
          <p className={textClass}>
            Welcome to {PRODUCT_NAME}. These Terms of Service ("Terms") govern
            your access to and use of the {PRODUCT_NAME} website located at{" "}
            <a href={SITE_URL} className={linkClass}>
              {SITE_URL}
            </a>
            , and any related services, features, or content offered by{" "}
            {COMPANY_NAME} ("we," "us," or "our") (collectively, the "Service").
          </p>
          ...
          <p className={`mt-4 text-sm italic ${textClass}`}>
            Note: These terms of service are provided as a compliance template.
            We recommend consulting with a qualified legal professional before
            relying on them for production use.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            to be bound by these Terms, as well as our{" "}
            <a href={langPath("/privacy")} className={linkClass}>
              Privacy Policy
            </a>{" "}
            and{" "}
            ...
            , which are incorporated herein by reference. We reserve the right
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            jurisdiction), you may only use the Service under the supervision of
        ...
        <div className={sectionClass}>
          ...
          <p className={`mt-3 ${textClass}`}>
            You may register using your email address or through third-party
            authentication providers (Google or Apple). We reserve the right to
            refuse registration or terminate accounts at our discretion.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            {PRODUCT_NAME} offers both free and paid subscription plans. Paid
            plans are available on a monthly or yearly basis. Details of current
            plan offerings, including pricing and included features, are
            displayed on the Service at the time of purchase.
          </p>
          ...
          <p className={textClass}>
            ...
            cycle (monthly or yearly) unless you cancel your subscription before
            the renewal date. You will be charged the then-current subscription
          ...
          <p className={textClass}>
            ...
            including Airwallex, PayPal, and Stripe. By providing payment
            information, you authorize us (and our payment processors) to charge
            your selected payment method for the applicable fees. All payment
            processing is subject to the terms and privacy policies of the
          ...
          <p className={textClass}>
            ...
            billing period. You will continue to have access to paid features
            until the end of your paid period. No partial refunds are provided
          ...
          <p className={textClass}>
            Certain features of the Service may require credits. Credits may be
            earned through subscription plans, purchased separately, or awarded
            as bonuses. Credits are non-transferable, non-refundable, and have
            no cash value. We reserve the right to modify the credit system,
            including pricing and allocation, at any time.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <ul className={listClass}>
            ...
            <li>
              ...
              Service, including through the introduction of malware, viruses,
              or harmful code.
            </li>
            <li>
              Use automated means (bots, scrapers, crawlers) to access or
              collect data from the Service without our prior written consent.
            </li>
            <li>
            ...
            <li>
              Use the Service to harass, abuse, threaten, or harm other users or
              any third party.
            </li>
            <li>
            ...
            <li>
              Share, resell, or redistribute your account access or any content
              generated through the Service for commercial purposes without our
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            exclusive property of {COMPANY_NAME} and its licensors. The Service
            is protected by copyright, trademark, and other intellectual
            property laws. Our trademarks, trade names, logos, and service marks
          ...
          <p className={`mt-3 ${textClass}`}>
            ...
            royalty-free license to use, store, and process that content solely
        ...
        <div className={sectionClass}>
          ...
          <p className={`font-medium mb-3 ${strongClass}`}>
            IMPORTANT: The astrological content, readings, and AI-generated
            insights provided through the Service are intended for entertainment
            and self-reflection purposes only.
          </p>
          <p className={textClass}>
            The Service does NOT provide and should NOT be considered as a
            substitute for:
          </p>
          <ul className={`mt-3 ${listClass}`}>
            <li>
              <span className={strongClass}>Medical advice:</span> The Service
              is not a healthcare provider and does not diagnose, treat, cure,
              or prevent any disease or medical condition.
            </li>
            <li>
              <span className={strongClass}>Legal advice:</span> The Service
              does not provide legal counsel or representation.
            </li>
            <li>
              <span className={strongClass}>Financial advice:</span> The Service
              does not provide investment, financial planning, or tax advice.
            </li>
            <li>
              <span className={strongClass}>
                Psychological or therapeutic advice:
              </span>{" "}
              While the Service draws on psychological frameworks for
              self-reflection, it is not a substitute for licensed therapy,
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            {COMPANY_NAME.toUpperCase()}, ITS DIRECTORS, EMPLOYEES, PARTNERS,
          ...
          <ul className={`mt-3 ${listClass}`}>
            ...
            <li>
              Any decisions made or actions taken based on information provided
              through the Service.
            </li>
          </ul>
          <p className={`mt-4 ${textClass}`}>
            IN NO EVENT SHALL OUR TOTAL LIABILITY TO YOU FOR ALL CLAIMS ARISING
            OUT OF OR RELATING TO THE SERVICE EXCEED THE AMOUNT YOU PAID TO US
            IN THE TWELVE (12) MONTHS IMMEDIATELY PRECEDING THE EVENT GIVING
            RISE TO THE CLAIM, OR ONE HUNDRED U.S. DOLLARS ($100), WHICHEVER IS
            GREATER.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            including any intellectual property or privacy right; or (d) any
            claim that your content or actions caused damage to a third party.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <p className={`mt-3 ${textClass}`}>
            ...
            or through your account settings. Upon account termination, your
            personal data will be handled in accordance with our{" "}
            <a href={langPath("/privacy")} className={linkClass}>
              Privacy Policy
            </a>
            .
          ...
          <p className={`mt-3 ${textClass}`}>
            ...
            Property, Disclaimer, Limitation of Liability, Indemnification,
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            These Terms and Conditions are governed by the laws of the Hong Kong
            Special Administrative Region of the People's Republic of China.
            Your order will be processed in accordance with the laws of Hong
            Kong. Any disputes arising out of or relating to these Terms or the
            Service shall be resolved exclusively in the courts of the Hong Kong
            Special Administrative Region, and you consent to the personal
          ...
          <p className={`mt-3 ${textClass}`}>
            ...
            residence. Nothing in these Terms shall limit any rights you may
            have under applicable consumer protection laws in your jurisdiction.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            Before filing a legal claim, you agree to first attempt to resolve
            any dispute informally by contacting us at{" "}
            <a href={`mailto:${CONTACT_EMAIL}`} className={linkClass}>
              {CONTACT_EMAIL}
            </a>
            . We will make reasonable efforts to resolve the dispute within 30
            days. If the dispute cannot be resolved informally, either party may
            pursue legal remedies as described in the Governing Law section
            above.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            least 30 days' notice prior to the new terms taking effect, either
            through the Service interface or via email. What constitutes a
            "material change" will be determined at our sole discretion.
          </p>
          <p className={`mt-3 ${textClass}`}>
            Your continued use of the Service after the effective date of the
            revised Terms constitutes your acceptance of the updated Terms. If
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            invalid, that provision will be modified and interpreted to
            accomplish the objectives of that provision to the greatest extent
        ...
        <div className={sectionClass}>
          ...
          <ul className={`mt-3 space-y-2 ${textClass}`}>
            ...
            <li>
              <span className={strongClass}>Address:</span> Rm A133 of Unit 1,
              15/F, Block A, Wah Sang Building, No. 14-18 Wong Chuk Yeung
              Street, Sha Tin, Hong Kong
            </li>
          </ul>
        </div>
