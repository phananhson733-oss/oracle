...
const HelpPage: React.FC = () => {
  ...
  // Inject FAQPage JSON-LD schema. Self-dedupe (mirrors App.tsx GlobalSchema /
  // Breadcrumb): if a FAQPage already exists (prerendered stub or a page <SEO>
  // schema), skip — a duplicate FAQPage trips GSC's "duplicate field" error.
  useEffect(() => {
    if (typeof document === "undefined") return;

    const hasFaq = Array.from(
    ...
    return () => {
      document
        .querySelectorAll("[data-astro-faq-schema]")
  ...
  return (
    <Container>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        {/* Contact CTA */}
        <div
          className={`mt-12 pt-8 border-t ${theme === "dark" ? "border-star-50/10" : "border-paper-200"}`}
        >
        ...
        {/* Back link */}
        <div
          className={`mt-8 pt-6 border-t ${theme === "dark" ? "border-star-50/10" : "border-paper-200"}`}
        >
