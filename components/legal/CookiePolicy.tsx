...
const CookiePolicy: React.FC = () => {
  ...
  const tableBorderClass =
    theme === "dark" ? "border-star-400/20" : "border-paper-600/20";
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className={sectionClass}>
          <p className={textClass}>
            This Cookie Policy explains how {PRODUCT_NAME} (operated by{" "}
            {COMPANY_NAME}) uses cookies and similar tracking technologies when
            you visit our website at{" "}
            <a href={SITE_URL} className={linkClass}>
              {SITE_URL}
            </a>{" "}
            (the "Service"). It explains what these technologies are, why we use
            them, and your rights to control our use of them.
          </p>
          <p className={`mt-4 text-sm italic ${textClass}`}>
            Note: This cookie policy is provided as a compliance template. We
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            site. Cookies can be "persistent" (remaining on your device for a
            set period or until you delete them) or "session-based" (deleted
            when you close your browser).
          </p>
          <p className={`mt-3 ${textClass}`}>
            In addition to cookies, we may also use similar technologies such as
            pixels, web beacons, and local storage to collect and store
            information.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <div className="overflow-x-auto mt-4">
            <table
              className={`w-full border-collapse border ${tableBorderClass} text-sm`}
            >
              <thead>
                <tr className={tableHeaderClass}>
                  <th
                    className={`border ${tableBorderClass} px-4 py-3 text-left font-semibold`}
                  >
                    Category
                  </th>
                  <th
              ...
              <tbody>
                <tr>
                  <td
                    className={`border ${tableBorderClass} px-4 py-3 font-medium ${strongClass}`}
                  >
                    Essential
                  </td>
                  <td
                  ...
                  >
                    ...
                    management, authentication tokens, language preferences, and
                    theme settings.
                  </td>
                  <td
                    className={`border ${tableBorderClass} px-4 py-3 ${tableCellClass}`}
                  >
                    <span className={strongClass}>Always active</span> - cannot
                    be disabled
                  </td>
                </tr>
                <tr>
                  ...
                  >
                    ...
                    anonymized usage data including page views, session
                    duration, and user navigation patterns.
                  </td>
                  <td
                    className={`border ${tableBorderClass} px-4 py-3 ${tableCellClass}`}
                  >
          ...
          <h3 className={`text-lg font-medium mb-2 mt-8 ${strongClass}`}>
            2.1 Essential Cookies
          </h3>
          <p className={`mb-3 ${textClass}`}>
            These cookies are strictly necessary for the Service to operate.
            Without these cookies, certain features of the Service would not be
            available. Essential cookies include:
          </p>
          <ul className={listClass}>
            <li>
              <span className={strongClass}>Session Management:</span> Cookies
              that maintain your session state as you navigate between pages,
              ensuring you remain logged in and your preferences persist.
            </li>
            <li>
              <span className={strongClass}>Authentication:</span> Cookies that
              identify you as a logged-in user and authorize access to protected
              features. This includes tokens for email-based authentication and
              third-party sign-in (Google, Apple).
            </li>
            <li>
              <span className={strongClass}>User Preferences:</span> Cookies
              that store your selected language (English or Chinese) and theme
              preference (dark or light mode).
            </li>
            <li>
              <span className={strongClass}>Cookie Consent:</span> A cookie that
              records your consent choices for non-essential cookies.
            </li>
          </ul>
          ...
          <p className={`mb-3 ${textClass}`}>
            We use analytics cookies to understand how the Service is being used
            so we can improve it. These cookies collect information in an
            aggregated and anonymized form. Specifically:
          </p>
          <ul className={listClass}>
            <li>
              <span className={strongClass}>Google Analytics 4 (GA4):</span>{" "}
              Collects anonymized data about page views, session duration, user
              interactions, traffic sources, and device information. GA4 uses
              first-party cookies and does not collect personally identifiable
              information by default. Data is processed in accordance with{" "}
              <a
            ...
            <li>
              <span className={strongClass}>Google Tag Manager (GTM):</span> A
              tag management system that enables us to manage and deploy
              analytics and measurement tags on the Service. GTM itself does not
              collect personal data but facilitates the operation of other
              analytics tools.
            </li>
          </ul>
        ...
        <div className={sectionClass}>
          ...
          <p className={`mb-3 ${textClass}`}>
            In addition to our own cookies, the following third parties may set
            cookies on your device when you use the Service:
          </p>
          <ul className={listClass}>
            <li>
              <span className={strongClass}>Google:</span> Through Google
              Analytics 4, Google Tag Manager, and Google Sign-In. These cookies
              are governed by{" "}
              <a
                href="https://policies.google.com/privacy"
                target="_blank"
            ...
            <li>
              <span className={strongClass}>Payment Providers:</span> When you
              make a payment, our payment processors (Airwallex, PayPal, Stripe)
              may set cookies on their own payment pages to process transactions
              securely and prevent fraud. These cookies are governed by each
              provider's respective privacy policy.
            </li>
            <li>
              <span className={strongClass}>Apple:</span> If you use "Sign in
              with Apple," Apple may set cookies for authentication purposes,
              governed by{" "}
              <a
        ...
        <div className={sectionClass}>
          ...
          <p className={`mb-3 ${textClass}`}>
            ...
            settings. You can typically find these settings in the "Options,"
            "Preferences," or "Privacy" menu of your browser. Here are links to
          ...
          <p className={`mt-3 ${textClass}`}>
            ...
            the Service. Essential cookies cannot be disabled as they are
          ...
          <p className={textClass}>
            ...
            , which prevents Google Analytics JavaScript from sharing
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            websites that you do not want to be tracked. At this time, there is
            no universally accepted standard for how to respond to DNT signals.
            We currently do not respond to DNT signals, but we respect your
            cookie consent choices made through our consent banner.
          </p>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <p className={textClass}>
            ...
            Service or request renewed consent.
          </p>
        </div>
