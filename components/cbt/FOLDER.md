<!-- INPUT: CBT 组件目录结构与职责说明（含统计解读权限校验、统计入口卡片精简展示、AI 文本清理、月份导航统一、无记录占位与情绪配色优化、占星解读语义分行与解读标签优化）。 -->
<!-- OUTPUT: CBT 组件目录文档（含统计解读权限校验与统计入口精简展示、AI 文本净化更新说明、月份导航统一、无记录处理与占星解读分区排版更新、统计缓存键优化）。 -->
