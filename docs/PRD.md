...
**配额**: 免费 3 次/周，订阅 5 次/周，或消耗 20 credits/次
...
**配额**: 免费 3 次（终身永久额度），订阅 +2 次/周，或 30 credits/次
...
|------|------|------|
| **月付** | $6.99/月 | 自动续费，随时取消 |
| **年付** | $55.99/年 (Airwallex) | 相当于 $4.67/月，节省 33%。注：Stripe 遗留链路年付为 $67.10/年（20% 折扣） |
...
|------|--------|----------|----------|------|
| Starter Pack | 100 | $9.99 | ¥68 | — |
| Standard Pack | 300 | $24.99 | ¥168 | 17% |
| Value Pack | 500 | $39.99 | ¥268 | 20% |
| Pro Pack | 1,000 | $69.99 | ¥468 | 30% |
...
| 功能 | 额外限额 | 重置周期 |
|------|----------|----------|
| Ask 提问 | +2 次/周 | 每周一 00:00 UTC |
| Synastry 合盘 | +2 次/周 | 每周一 00:00 UTC |
